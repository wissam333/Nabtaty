...
export default defineNuxtConfig({
  ...
  fontawesome: {
    icons: {
      ...
      brands: ["facebook", "x-twitter", "linkedin", "whatsapp"],
    },
  },

  primevue: {
    components: {
      include: ["Galleria", "DataTable", "Column"],
    },
    options: {
      theme: {
        preset: lara,
  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { name: "description", content: "Royal Art Wooden Factory" },
      ],
      link: [
        {
          rel: "stylesheet",
  ...
  runtimeConfig: {
    serverApiBase: "https://admin.royalartfactory.net",
    serverApi: {
    ...
    public: {
      apiBase: "https://admin.royalartfactory.net",
      api: {
        // Auth
