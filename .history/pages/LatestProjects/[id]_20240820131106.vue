<template>
  ...
  <div class="projects card nav-margin">
    <h1 class="fw-bold title d-flex justify-content-center align-items-end">
      <!-- <img width="80" src="/photos/icons/Asset 1.png" alt="" /> -->
      {{ $i18n.locale === "ar" ? Projects?.name : Projects?.englishName }}
    </h1>
    <div class="d-flex justify-content-center mb-5">
      <!-- <img class="logo" src="/photos/icons/Asset 4.png" /> -->
    </div>
    <div class="">
      <div class="project" v-for="project in Projects?.blockPhotos">
        <div
          class="project-img"
          :style="{ backgroundImage: `url(${apiBase}/${project?.image})` }"
        >
          <div class="overlay"></div>
          <!-- <img :src="`${apiBase}/${project?.image1}`" alt="" /> -->
          <nuxt-link
            :to="`/Projects/${Projects?.id?.toString()}`"
...
const { data: Projects, pending } = await useGetSiteApi().GetById(
  `${api.Blocks}/`,
  [
    "id",
    "englishName",
