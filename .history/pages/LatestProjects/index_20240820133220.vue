<template>
  ...
  <div class="projects nav-margin">
    <h1
      class="fw-bold mt-5 title d-flex justify-content-center align-items-end"
    >
      <!-- <img width="80" src="/photos/icons/Asset 1.png" alt="" /> -->
      {{ $i18n.locale === "ar" ? "احدث المشاريع" : "Latest Projects" }}
    </h1>
    ...
    <div class="">
      <div class="project" v-for="project in Projects?.items">
        ...
        >
          ...
          <nuxt-link
            :to="`/LatestProjects/${project?.id?.toString()}`"
