  ...
  >
    ...
    <div class="information container">
      <v-window v-model="tab2" style="color: #333 !important; opacity: 1">
        ...
        <v-window-item value="two" style="color: #333 !important; opacity: 1">
          <div class="row">
            <div class="col-lg-6 desc">
              <h2>{{ $i18n.locale === "ar" ? "الوصف" : "Description" }}</h2>
              <p>
        ...
        <v-window-item value="three" style="color: #333 !important; opacity: 1">
          <div class="row">
            <div class="col-lg-6 desc">
              <h2>{{ $i18n.locale === "ar" ? "الوصف" : "Description" }}</h2>
              <p>
