...
watchEffect(() => {
  if (process.client) {
    if (Product.value) {
      Sizes.value[0].Price = Product.value[0].price1;
      Sizes.value[1].Price = Product.value[0].price2;
      Sizes.value[2].Price = Product.value[0].price3;
      Sizes.value[3].Price = Product.value[0].price4;
...
const AddToCart = (item) => {
  ...
  item.price = activeSize.value[0].Price;
  item.selectedSize = activeSize.value[0].name;
