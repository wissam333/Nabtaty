  ...
  >
    ...
    <div v-else class="container" style="position: relative">
      ...
      <h5 class="links mb-10">
        ...
        / -->
        {{ $i18n.locale === "ar" ? Product[0]?.plant_name : Product[0]?.plant_name }}
      </h5>
      ...
      <div class="row">
        ...
        <div class="info col-lg-6">
          ...
          <!-- Desc -->
          <div class="desc mt-5" v-if="Product?.description">
            <div
              v-html="
                $i18n.locale === 'ar'
        ...
        <div class="col-12 col-lg-6 mb-10">
          <!-- <ProductDetailsProductImagesCarousel
            ...
            :ProductMainImg="Product?.photos"
            :disscount="Product?.productOffer?.discountRatio"
          ></ProductDetailsProductImagesCarousel> -->
          <img
            class="w-100 h-100"
            :src="`${apiBase}/${Product[0]?.productPhotos}`"
            alt=""
          />
        </div>
      </div>
