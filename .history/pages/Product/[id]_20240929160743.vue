      ...
      <div class="row">
        <div class="col-12 col-lg-6 mb-10">
          <ProductImagesCarousel
            ...
            :disscount="Product?.data?.productOffer?.discountRatio"
          ></ProductImagesCarousel>
        </div>
            ...
            <div class="mt-4" style="color: #333 !important; opacity: 1">
              ...
              >
                ...
                >
                  ...
                  <div class="desc" v-if="Product?.data?.arabicDescription">
                    <div
                      v-html="
                        $i18n.locale === 'ar'
                          ? Product?.data?.arabicDescription
                          : Product?.data?.englishDescription
                      "
                    ></div>
                  </div>
                  <div
