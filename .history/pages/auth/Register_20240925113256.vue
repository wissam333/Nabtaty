  ...
  <div class="register nav-margin">
    <div class="container">
      ...
      >
        ...
        <!-- <div class="mb-5 row">
              <div class="col-lg-4">
                ...
                <div
                  ...
                  style="border: 1px solid #bf9847; height: 54px"
                >
                  <div class="px-1 w-40">
        ...
        <div class="row justify-center">
          <div class="col-lg-6">
            <!-- <label for="buttondisplay" class="fw-bold d-block color mb-3">
              {{ $t("City") }}
            </label> -->
            <ElementsFormVSelect
              :label="$t('City')"
  ...
  if (data.value) {
    if (!data.value.succeeded) {
      ...
      const AddPersonValue = {
        ...
        persomImageUrl: null,
        nationId: 1, // selectedCountry.value
...
input {
  box-shadow: 0px 0px 11px 0px #aaaaaa69 !important;
}
</style>
