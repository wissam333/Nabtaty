        ...
        <div class="col-lg-6">
          ...
          >
            ...
            <ElementsFormVTextInput
              ...
              color="146890"
              type="text"
              name="mangerFullNameEn"
              id="mangerFullNameEn"
              :label="
                $i18n.locale === 'ar'
                  ? ''
                  : 'Name of responsible Company in English'
              "
              :placeholder="$t('Full Name Ar')"
            />
            ...
            <ElementsFormVTextInput
              ...
              :label="
                $i18n.locale === 'ar'
                  ...
                  : 'Responsible Company mobile number'
              "
              :placeholder="
                $i18n.locale === 'ar'
                  ? 'رقم موبايل الشخص المسؤول'
  ...
  if (data.value) {
    if (!data.value.succeeded) {
      ...
      const AddCompanyValue = {
        ...
        phone: "0987656765",
        princedomId: 3,
        responsiblePersonMobile: "0987878787",
        responsiblePersonNameAr: "وسام نجوم",
        responsiblePersonNameEn: "wissam najjom",
        sectionId: 0,
        status: "Accepted",
        userId: "a208fe22-7159-4c4a-a3cb-795468eff923",
        website: "W.com",
      };
      values.email != "" ? (AddCompanyValue.email = values.email) : "",
        values.fullNameAr != ""
          ? (AddCompanyValue.fullNameAr = values.fullNameAr)
          : "";
      values.fullNameAr != ""
        ? (AddCompanyValue.fullNameEn = values.fullNameAr)
        : "";
      values.fullNameEn != ""
        ? (AddCompanyValue.fullNameEn = values.fullNameEn)
        : "";
      values.fullNameEn != ""
        ? (AddCompanyValue.fullNameAr = values.fullNameEn)
        : "";
      AddCompanyValue.sex = values.sex;
