<template>
  <div class="Partiners">
    <div class="cont">
      <h1 class="title d-flex justify-content-start align-items-center">
        <img width="100" src="/photos/icons/new.png" alt="" />
        {{ $i18n.locale === "ar" ? "العملاء" : "Partiners" }}
      </h1>
      <Swiper
...
const { data: Partiners, pending } = await useGetSiteApi().GetAll(
  `${api.Blocks}?categoryId=4&pageSize=1000`,
