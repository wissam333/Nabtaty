          ...
          >
            ...
            >
              ...
              <div class="d-flex align-items-center justify-space-between mb-2">
                <div
                  style="border: 2px solid #003d2ec2"
        ...
        <div class="col-lg-4">
          ...
          >
            ...
            <div class="text-center mt-5">
              ...
              <NuxtLink v-else class="w-75" to="/SignIn">
                <button class="Check background px-5 py-2 text-white">
                  {{ $i18n.locale == "ar" ? "اطلب الطلبية" : "Order Now" }}
                </button>
              </NuxtLink>
...
.title {
  ...
  span {
    ...
    font-weight: bold;
    background-color: #003d2ec2;
    background-image: linear-gradient(to right, #191d23, #003d2ec2);
