<template>
  <Socials></Socials>
  <div class="about card nav-margin" :class="$i18n.locale === 'ar' ? 'ar' : ''">
    <div class="container">
      <h1
        class="fw-bold pt-5 title d-flex justify-content-center align-items-center"
      >
