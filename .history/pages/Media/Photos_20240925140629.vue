...
import Lightgallery from "../../node_modules/lightgallery/vue/LightGallery.vue";
import lgThumbnail from "../../node_modules/lightgallery/plugins/thumbnail/lg-thumbnail";
import lgZoom from "../../node_modules/lightgallery/plugins/zoom/lg-zoom";

// Define plugins array using ref since it's reactive
const plugins = ref([lgThumbnail, lgZoom]);

// Event handler for lightGallery initialization
const onInit = () => {
  console.log("lightGallery has been initialized");
};

// Event handler for when the slide is about to change
const onBeforeSlide = () => {
