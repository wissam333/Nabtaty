    ...
    <div class="container">
      ...
      <div v-else-if="pending === false" class="container">
        <h2 class="news-title mb-10 d-flex align-items-start">
          ...
          <div>
            {{ $i18n.locale === "ar" ? News?.name : News?.englishName }}
            <p class="date mt-3">{{ formatDate(News?.newsDate) }}</p>
          </div>
        </h2>

        <div v-if="News?.description" class="news-detail-wrapper row mb-5">
          <div
            class="news-image col-lg-6"
            :style="`background: url(${apiBase}${News?.image})`"
            :data-aos="$i18n.locale === 'ar' ? 'fade-right' : 'fade-left'"
          >
            <img
              v-if="News?.image"
              :src="`${apiBase}${News?.image}`"
        ...
        <div v-if="News?.description2" class="news-detail-wrapper row mb-5">
          <div
            class="news-image col-lg-6"
            :data-aos="$i18n.locale === 'ar' ? 'fade-right' : 'fade-left'"
          >
