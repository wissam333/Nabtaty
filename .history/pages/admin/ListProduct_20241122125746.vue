  ...
  <div class="contain" :class="useSidebar().value ? 'shrink' : ''">
    <div class="title-container">
      ...
      <div class="options">
        ...
        <div class="reload btn btn-success mx-2" @click="getProduct()">
          <font-awesome :icon="['fas', 'rotate-right']" />
          {{ $i18n.locale === "ar" ? "إعادة تحميل" : "Reload" }}
        </div>
        <div class="reload btn btn-success" @click="exportToExcel">
          <!-- <font-awesome :icon="['fas', 'rotate-right']" /> -->
...
const deletePlant = async () => {
  // delete plant photos
  deleteProduct.value.photos?.map((photo) => {
    removeImage(photo.photo_id);
  });
