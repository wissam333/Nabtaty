  ...
  <div class="contain" :class="useSidebar().value ? 'shrink' : ''">
    <div class="title-container">
      ...
      <div class="options">
        ...
        <div v-if="!details" class="reload btn btn-success mx-2" @click="getInfo()">
          <font-awesome :icon="['fas', 'rotate-right']" />
          {{ $i18n.locale === "ar" ? "إعادة تحميل" : "Reload" }}
        </div>
        <div v-else class="reload btn btn-success mx-2" @click="details = false">
          <!-- <font-awesome :icon="['fas', 'rotate-right']" /> -->
        ...
        <table>
          ...
          <tbody>
            ...
            >
              ...
              <td class="fw-bold">{{ Number(product?.price) }} JOD</td>
              <td class="fw-bold">
                {{ Number(product?.price) * product.quantity }} JOD
              </td>
            </tr>
          </tbody>
        </table>
