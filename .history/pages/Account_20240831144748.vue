        ...
        >
          <v-tabs v-model="tab" bg-color="transparent">
            <v-tab
              ...
              value="1"
            >
              <button class="nav-link py-2 active">
                <span class="fs-sm-4">{{
...
.v-btn.v-slide-group-item--active.v-tab--selected.v-theme--light.v-btn--density-default.v-btn--size-default.v-btn--variant-text.Fv-tab.nav-item {
