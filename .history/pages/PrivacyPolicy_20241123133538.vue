  ...
  <div class="about">
    <div class="container">
      <div class="title">
        ...
        <div class="">
          <div class="row  mb-10" v-for="(about, index) in Privacy" :key="about.id">
            <div
            ...
            >
              <div>
                {{ $i18n.locale === "ar" ? about?.content : about?.content }}
              </div>
            </div>
          </div>
        </div>
...
const { data: Privacy } = await useFetch(`${api.GetPrivacy}`, {
  baseURL: apiBase,
  credentials: "include",
  headers: {
