<template>
  <div>
    <h1 class="color text-center mt-5 mb-5 fw-bold">{{ $t("My Cart") }}</h1>
    <div class="container">
      <div class="row" v-if="cart.totalQty > 0">
        <div class="col-lg-8">
          ...
          >
            ...
            <div class="mx-5">
              ...
              <p class="text-muted fw-bold">{{ item.price }} د.ل</p>
              <div class="d-flex align-items-center justify-space-between">
                <div
                  style="border: 2px solid #00c2ec"
                  class="d-inline-flex align-items-center py-2 px-10"
                >
                  <font-awesome
                    style="color: #00c2ec; cursor: pointer"
                    @click="decreaseQty(item.id, index)"
                    :icon="['fas', 'minus']"
                  />
                  <span
                    class="mx-3 quantity color"
        ...
        <div class="col-lg-4">
          <div class="" style="border: 1px solid #00c2ec">
            <h4
