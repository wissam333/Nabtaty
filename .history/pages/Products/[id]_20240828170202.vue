        ...
        <div class="info col-lg-6">
          ...
          <div class="mb-2">
            <v-tabs v-model="tab" bg-color="transparent">
              ...
              >
              <v-tab style="color: #af9458; font-weight: bold" value="two">{{
                $i18n.locale == "en" ? "Dimension" : "الآبعاد"
              }}</v-tab>
              <v-tab style="color: #af9458; font-weight: bold" value="three">{{
                $i18n.locale == "en" ? "Shipping & Retun" : "الشحن والإرجاع"
              }}</v-tab>
              <v-tab
                style="
                  color: #af9458;
                ...
                "
                value="four"
                >{{ $i18n.locale == "en" ? "Care" : "العناية" }}</v-tab
              >
            </v-tabs>

            <div class="mt-4" style="color: #fff !important; opacity: 1">
              <v-window
                v-model="tab"
