        ...
        <div class="info col-lg-6">
          <span v-if="isAuth.isAuthenticated">
            ...
            <font-awesome v-else :icon="['far', 'heart']" />
              ...
              <img v-if="!ProductForFavorite.isFavorite" @click="AddToFavorite()" src="/newdisign/whiteheart.png"  class="  pointer" width="25" alt="">
              <img v-else  @click="removeFromFavorite()" src="/newdisign/heart3.png"  class=" pointer" width="25" alt="">
            </span>
            <span v-else>
              <img @click="AddToFavoritebeforLogin()" src="/newdisign/whiteheart.png"  class="  pointer" width="25" alt="">
            </span>
