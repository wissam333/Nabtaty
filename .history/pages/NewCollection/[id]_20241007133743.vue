  ...
  <div class="Products">
    ...
    <div>
      <h1 class="linear page-title">
        ...
        />
        <span>
          {{ $i18n.locale === "ar" ? "منتجات جديدة" : "New Collection" }}
        </span>
      </h1>
    </div>
    ...
    <div class="cont">
      ...
      <div class="row">
        ...
        <div v-else class="col-lg-10">
          <div class="grid3" v-if="selectedId == 9 || selectedId == 11">
            <div
              class="product"
            ...
            >
              <div>
                <CardsProductCard :product="product"></CardsProductCard>
              </div>
            </div>
          </div>
          <div class="grid2" v-else>
            ...
            >
              <div>
                <CardsProductCard2 :product="product"></CardsProductCard2>
              </div>
            </div>
          </div>
...
const { data: Products, pending: loadingProducts } =
  await useGetSiteApi().GetAll(
    `${api.Newcollection}?categoryId=${route.params.id}&pageSize=1000000000`
  );
