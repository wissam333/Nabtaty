<template>
  <div>
    <h1 class="color mt-5 mb-5 text-center fw-bold">{{ $t("My Account") }}</h1>
  </div>
  <div class="container">
    <div class="mt-5" style="min-height: calc(100vh - 110px)">
      ...
      <div class="container-fluid" style="min-height: 450px">
        <div class="tab-content" id="pills-tabContent">
          ...
          >
            <MyaccountUserOrder v-if="data" :order="data.data" />
            <MyaccountUserOrderMobile v-if="data" :order="data.data" />
          </div>
