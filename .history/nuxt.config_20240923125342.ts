...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { name: "description", content: "Baddar Furniture" },
      ],
      link: [
        {
          rel: "stylesheet",
        ...
        {
          rel: "icon",
          href: "/AlMuadalahLogoRamli.60ed7b1.png",
          type: "image/x-icon",
        },
      ],
      script: [
  ...
  runtimeConfig: {
    ...
    serverApi: {
      ...
      //categories
      ProductsCategories: "/api/productcategories?pageNumber=0&pageSize=10",
