  ...
  .container {
    ...
    .wrap {
      .card {
        ...
        padding: 30px 60px;
        color: #fff;
        background: linear-gradient(to left, $main, #f5d682, $main),
          linear-gradient(to top, #bf9847, #f5d682, #bf9847);
        border: none;
