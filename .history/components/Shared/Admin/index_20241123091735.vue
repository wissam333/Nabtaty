    ...
    <ul class="main-links">
      ...
      >
        <div>
          <font-awesome :icon="['fas', 'globe']" />
          <span>{{
            $i18n.locale === "ar" ? "الصفحات الفرعية" : "Sub Pages"
          }}</span>
        </div>
        <font-awesome
          class="caret"
      ...
      <ul class="second-links" :class="pageDropDown ? 'showLink' : ''">
        ...
        <nuxt-link to="/admin/PrivacyPolicy">
          <li
            :class="activeLink == 'Privacy' ? 'active' : ''"
            @click="productDropDown = false"
          >
            <span>{{
              $i18n.locale === "ar" ? "التواصل" : "Privacy Policy"
            }}</span>
          </li>
        </nuxt-link>
      </ul>
