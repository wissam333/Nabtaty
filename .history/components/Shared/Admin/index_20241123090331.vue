<template>
  ...
  <div class="sidebar box" :class="useSidebar().value ? '' : 'open'">
    <ul class="main-links">
      ...
      <ul
        class="second-links"
        :class="{ showLink: activeDropdown === 'Products' }"
      >
        <nuxt-link to="/admin/AddProduct">
          <li :class="{ 'sub-active': subActiveLink === 'AddProducts' }">
        ...
        <nuxt-link to="/admin/ListProduct">
          <li :class="{ 'sub-active': subActiveLink === 'ListProducts' }">
      ...
      <nuxt-link to="/admin/Category">
        <li
          :class="activeLink == 'Category' ? 'active' : ''"
          @click="productDropDown = false"
        >
          <font-awesome :icon="['fas', 'list']" />
      ...
      <nuxt-link to="/admin/SubCategory">
        <li
          :class="activeLink == 'SubCategory' ? 'active' : ''"
          @click="productDropDown = false"
        >
          <font-awesome :icon="['fas', 'list']" />
          <span>{{
      ...
      <nuxt-link to="/admin/ContactInfo">
        <li
          :class="activeLink == 'ContactInfo' ? 'active' : ''"
          @click="productDropDown = false"
        >
      ...
      <nuxt-link to="/admin/Messages">
        <li
          :class="activeLink == 'Messages' ? 'active' : ''"
          @click="productDropDown = false"
        >
...
const toggleDropdown = (menu) => {
  if (activeDropdown.value === menu) {
    ...
    activeDropdown.value = menu; // Open the clicked menu
  }
  activeLink.value = menu; // Update active link
};

// Close all dropdowns when a main menu is clicked
