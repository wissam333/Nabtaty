    ...
    <div class="top" :class="$i18n.locale === 'en' ? 'en' : ''">
      ...
      >
        ...
        <div class="d-flex">
          ...
          <div
            v-else
            class="pointer login text-center dropdown"
            aria-current="page"
            aria-expanded="false"
          ...
          <!-- cart -->
          <nuxt-link to="/Cart" class="cart pointer" style="position: relative">
            <small class="cartbox" v-if="cart.totalQty > 0">{{
              cart.totalQty
            }}</small>
            <img width="25" src="/photos/cart.png" alt="" />
          </nuxt-link>
          <!-- search -->
          <div class="search pointer" @click="toggle">
            <img width="25" src="/photos/search.png" alt="" />
          </div>
        ...
        >
          ...
          <!-- search -->
          <div class="search mx-2 pointer" @click="toggle">
