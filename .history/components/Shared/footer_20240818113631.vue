  ...
  <div class="bottom">
    ...
    <div class="foot cont" :class="$i18n.locale === 'ar' ? 'ar' : ''">
      <div class="contact" data-aos="fade-up" data-aos-duration="1000">
        <ul>
          <li
            v-for="menu in Menus?.items?.slice(0, 4)"
            :key="menu.id"
            class="menu-item"
      ...
      <div class="links" data-aos="fade-up" data-aos-duration="1000">
        <ul class="menu-list">
          <li
            v-for="menu in Menus?.items?.slice(4)"
            :key="menu.id"
            class="menu-item"
            v-show="menu.type !== 'Drop Down Menu'"
          >
    ...
    <div class="c">
      <p>
        ...
        <span class="gulf-if">
          {{
            $i18n.locale === "ar" ? "النخبة الداخلية" : "Elite Interiorsuae"
          }}</span
        >
...
.bottom {
  ...
  .overlay {
    ...
    width: 100%;
    height: 100%;
    background: linear-gradient(180deg,in lch, #d4530c, #54311e);
  }
