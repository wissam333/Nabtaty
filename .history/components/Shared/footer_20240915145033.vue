      ...
      <div class="logo">
          ...
          <div
            ...
            v-html="
              $i18n.locale === 'ar'
                ...
                : ContactsDetails?.englishDescription
            "
          ></div>
        </div>
        ...
        >
          ...
          <div
            ...
            v-html="
              $i18n.locale === 'ar'
                ? ContactsDetails?.description1
                : ContactsDetails?.englishDescription1
            "
          ></div>
        </div>
        ...
        >
          ...
          <div
            ...
            v-html="
              $i18n.locale === 'ar'
                ? ContactsDetails?.description2
                : ContactsDetails?.englishDescription2
            "
          ></div>
        </div>
        ...
        <div
          ...
          v-html="
            $i18n.locale === 'ar'
              ...
              : ContactsDetails?.englishDesciption3
          "
        ></div>
        ...
        >
          ...
          <div class="socials-img">
            <a :href="Socials?.items[0]?.pageUrl" target="_blank" class="mx-2">
    ...
    <div class="c">
      <div class="contacts">
        <ul>
          ...
          <!-- <li v-for="menu in Menus2?.items" :key="menu.id" class="menu-item">
            <div class="paste-button">
              <div>
                <nuxt-link class="button" :to="menu.pageUrl">
                  {{ $i18n.locale === "ar" ? menu.name : menu.englishName }}
          ...
          <li class="menu-item">
            <div class="paste-button">
              <div>
                <nuxt-link class="button" to="/Media/News">
                  {{ $i18n.locale === "ar" ? "الأخبار" : "News" }}
                </nuxt-link>
              </div>
            </div>
          </li>
          ...
          <li class="menu-item">
            <div class="paste-button">
              <div>
                <nuxt-link class="button" to="/Media/Photos">
          ...
          <li class="menu-item">
            <div class="paste-button">
              <div>
                <nuxt-link class="button" to="/Media/Videos">
                  {{ $i18n.locale === "ar" ? "البوم الفيديو" : "Videos Album" }}
                </nuxt-link>
              </div>
            </div>
          </li>
...
const { data: Menus2 } = await useGetSiteApi().GetAll(
  `/api/v1/menus/GetMenuSub?categoryId=1&menuid=11`
);
