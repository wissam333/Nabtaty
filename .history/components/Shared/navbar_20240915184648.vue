<template>
          ...
          <div class="container">
            <ul>
              <li
                ...
                :key="menu.id"
                class="menu-item"
                v-show="menu.isActive && !menu.isFooter"
              >
                <div
                  class="paste-button"
              ...
              <li class="menu-item">
                <div @click="logoutModal">
                  <font-awesome :icon="['fas', 'power-off']" />
                  {{ $i18n.locale === "ar" ? "تسجيل الخروج" : "Logout" }}
                </div>
              </li>
            </ul>
          </div>
  ...
  <!-- OTP -->
  <ElementsAppModal :isOpen="logoutModal" @updateIsOpen="updateverfiyModal">
    <template #header>
      <h4>
        {{
          $i18n.locale === "ar"
    ...
    <template #footer>
      <button class="btn btn-secondary" @click="verfiyModal = false">
        {{ $i18n.locale === "ar" ? "إغلاق" : "Close" }}
      </button>
      <button
        class="btn btn-success"
        id="verifyButton"
        @click="verfiyAndRestPass(values.phone, code)"
      >
        {{ $i18n.locale === "ar" ? "تحقق" : "Verify" }}
      </button>
    </template>
  </ElementsAppModal>
</template>
...
.top {
  ...
  width: 100%;
  z-index: 100;
  background-color: rgb(0 74 112 / 74%);
  header {
    height: 170px;
    ...
    .navCollapsed {
      ...
      right: 0;
      bottom: 0;
      background-color: rgb(0 74 112 / 90%);
      height: 100vh;
      transition: all 0.3s ease-in-out;
