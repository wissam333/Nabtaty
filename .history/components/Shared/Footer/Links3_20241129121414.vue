  ...
  <div class="links" data-aos="fade-up">
    ...
    <div class="d-flex align-items-start justify-content-start">
      ...
      >
        ...
        <a v-if="Social[3]?.url" :href="Social[3]?.url" target="_blank" class="socials-img" style="">
          <!-- <font-awesome :icon="['fab', 'whatsapp']" /> -->
          <span> {{ Social[3].name }}</span>
        </a>

        <a v-if="Social[4]?.url" :href="Social[4]?.url" target="_blank" class="socials-img" style="">
          <!-- <font-awesome :icon="['fab', 'whatsapp']" /> -->
          <span> {{ Social[4].name }}</span>
        </a>
      </div>
    </div>
  </div>
