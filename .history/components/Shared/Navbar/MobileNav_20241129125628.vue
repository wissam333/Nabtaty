    ...
    <div class="container">
      ...
      <ul>
        ...
        <li>
          ...
          <nuxt-link
            to="/Fav"
            class="cart pointer  item d-flex align-items-center"
            style="position: relative"
          >
            <font-awesome :icon="['fas', 'heart']" />
            <span>{{ $i18n.locale === "ar" ? "المفضلة" : "Favourite" }}</span>
          </nuxt-link>
        </li>
        <li>
          <!-- cart -->
          <nuxt-link
            to="/Cart"
            class="cart pointer mx-2 item d-flex align-items-center"
            style="position: relative"
          >
            ...
            <span>{{ $i18n.locale === "ar" ? "السلة" : "Cart" }}</span>
          </nuxt-link>
        </li>
        <li>
          <!-- search -->
          <div
            class="search pointer mx-2 item d-flex align-items-center"
            style="color: rgba(0, 61, 46, 0.7607843137)"
            @click.stop="toggle"
          >
            <font-awesome :icon="['fas', 'magnifying-glass']" />
            <span>{{ $i18n.locale === "ar" ? "البحث" : "Search" }}</span>
          </div>
