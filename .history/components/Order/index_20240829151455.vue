<template>
  <section class="order nav-margin main-black-background py-5">
    <div class="container">
      <div class="py-md-5 text-center">
        <h1 class="color fw-bold d-inline-flex">
          ...
          >
            ...
            >
              ...
              >
                ...
                " -->
                <span class="text-black" v-if="!isLoading">
...
const initialValues = {
  ...
  payTypeId: 1,
  currencyId: 1,
  restaurantName: useCart().value.items[0].item.productCompany.nameAr,
};
...
const schema = object({
  ...
  restaurantName: string().required().label("Restaurant Name"),
});
