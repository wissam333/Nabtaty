<template>
  <section class="user-info">
    <div class="row">
      ...
      <!-- <div class="col-lg-6">
          <ElementsFormVSelect border_color="00c2ec"
          color="00c2ec" @change="changeResta" name="restaurantId" :items="restuarants.data" id="restaurantId" :label="$t('Restaurant')" :placeholder="$t('ChooseRestaurant')"  astricts="true" />
        </div> -->

      <!-- <div class="col-lg-6">
          <ElementsFormVTextInput border_color="00c2ec"
          color="00c2ec " name="restaurantName" id="restaurantName"  type="text" :label="$t('Restaurant')" :placeholder="$t('ChooseRestaurant')"  astricts="true" :readonly="true" />
        </div> -->

      <!-- <div class="col-lg-6">
          <ElementsFormVTextInput border_color="00c2ec"
              color="00c2ec" type="email" name="email" id="email" :label="$t('email')" :placeholder="$t('email')" astricts="true" :readonly="true" />
        </div> -->
      ...
      <div class="col-lg-6">
        <ElementsFormVTextInput
          ...
          id="addressEn"
          :label="$t('address1')"
          :placeholder="$t('address1') + ' ' + '(' + $t('optional') + ')'"
        />
      </div>
      <!-- {{ allcities }} -->
      <!-- <div class="col-lg-6">
          <ElementsFormVSelect border_color="00c2ec"
              color="00c2ec" name="currencyId" :items="Currency" id="currencyId" :label="$t('Currency1')" :placeholder="$t('Currency1')" astricts="true"/>
        </div> -->
