              ...
              <td>
                <NuxtLink :to="`/Products/${item.item.id}`">
                  <h6 :title="useTranslate(item.item, 'name')">
                    {{
                      (item.item.englishName?.length > 20
                        ? $i18n.locale === "ar"
                          ? item.item.arabicName.slice(0, 20) + "..."
                          : item.item.englishName.slice(0, 20) + "..."
                        : $i18n.locale === "ar"
                        ? item.item.arabicName
                        : item.item.englishName) ?? item.item.title.slice(0, 20) + "..."
                    }}
                  </h6>
                </NuxtLink>
              </td>
