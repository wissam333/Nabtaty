        ...
        <tbody>
          ...
          <template v-for="(item, index) in cart.items" :key="index">
            <tr v-if="item">
              ...
              <td>{{ (item.qty * item.price).toFixed(2) }} د.ل</td>
            </tr>
          </template>
          ...
          <tr>
            ...
            <td colspan="1"></td>
            <td colspan="1"></td>
            <td v-if="!shippingCostMap().value" class="py-3">
              <strong class="mb-0">{{ chippengcost }} د.ل</strong>
            </td>
            <td v-else class="py-3">
              <strong class="mb-0">{{ shippingCostMap().value }} د.ل</strong>
            </td>
          </tr>
          <tr>
            <td class="py-3 text-center" colspan="1">
            ...
            <td v-if="!shippingCostMap().value" class="py-3">
              <strong class="mb-0"
                >{{ cart.totalPrice + chippengcost }} د.ل</strong
              >
            </td>
            <td v-else class="py-3">
              <strong class="mb-0"
                >{{ cart.totalPrice + shippingCostMap().value }} د.ل</strong
              >
            </td>
          </tr>
        </tbody>
