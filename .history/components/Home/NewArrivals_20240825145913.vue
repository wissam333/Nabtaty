<template>
  <div class="offers" :class="$i18n.locale === 'ar' ? 'ar' : ''">
    <div class="container">
      <h1>{{ $i18n.locale === "ar" ? "وصل" : "New" }}</h1>
      <h1>{{ $i18n.locale === "ar" ? "حديثاً" : "Arrivals" }}</h1>
            ...
            <div class="products">
              ...
              >
                ...
                <div class="product-info">
                  ...
                  <nuxt-link to="/" class="btn btn-main mt-5">
                    <span>{{
                      $i18n.locale === "ar" ? "اطلب الآن" : "Order Now"
                    }}</span>
                  </nuxt-link>

                  <p class="old-price">
                    {{ product.price }}
                    {{ $i18n.locale === "ar" ? "درهم اماراتي" : "AED" }}
                  </p>
                  <p class="price">
                    {{ product.price }}
                    {{ $i18n.locale === "ar" ? "درهم اماراتي" : "AED" }}
    ...
    h1 {
      ...
      &:last-of-type {
        ...
        span {
          ...
          font-weight: bold;
          background-color: #146890;
          background-image: linear-gradient(45deg, #ec9605, #ffca70, #ec9605);
          background-repeat: repeat;
          background-size: 100%;
          -webkit-text-fill-color: transparent;
          -moz-background-clip: text;
