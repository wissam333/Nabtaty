<template>
  <div class="about" :class="$i18n.locale === 'ar' ? 'ar' : ''">
    <div class="container">
      <h1
        class="fw-bold mt-5 title d-flex justify-content-center align-items-center"
      >
        <!-- <img width="80" src="/photos/icons/1.png" alt="" /> -->
...
.about {
  &.ar {
    ...
    h2 {
      font-family: Abdo-Master, sans-serif !important;
      font-size: 25px;
      margin-bottom: 10px;
    }
  }
