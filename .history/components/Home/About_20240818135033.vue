      ...
      <div class="row vision">
        <div class="col-lg-6 vision-info" >
          ...
          <p>
            ...
            sapiente ipsum ex aspernatur ut nesciunt quaerat recusandae
            quisquam. Placeat neque repudiandae commodi voluptas voluptatibus
            magni maxime officia doloribus eos reprehenderit?
          </p>
          <div class="learn-more">
            {{ $i18n.locale === "ar" ? "اعرف المزيد" : "Learn More" }}
          </div>
