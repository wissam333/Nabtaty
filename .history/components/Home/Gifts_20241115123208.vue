<template>
  ...
  >
    <div class="container mt-10">
      <div class="see-all">
        <nuxt-link :to="`/Products/16`" class="btn">
      ...
      <div v-else>
        ...
        >
          <SwiperSlide v-for="product in Products" :key="product.id">
            ...
            >
              <GiftCard :product="product"></GiftCard>
            </div>
          </SwiperSlide>
        </Swiper>
      </div>
...
const { data: Products, pending } = await useFetch(`${api.GetPlantByCat}/16`, {
  baseURL: apiBase,
  method: "GET",
});
</script>
