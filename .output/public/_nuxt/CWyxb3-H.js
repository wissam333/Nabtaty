import{_ as se}from"./CRYH6EUk.js";import{_ as $,B as oe,u as ie,a as re,z as ce,d as le}from"./BACvjOH3.js";import{a as b,y as te,a3 as s,D as h,ag as v,u,as as de,N as ue,ab as d,a5 as g,F as ae,a0 as l,M as H,a4 as Q,a8 as i,ax as he}from"./BUNOv-RT.js";import{s as me}from"./NgkfIgsL.js";import{_ as fe}from"./B0waXuRe.js";import{u as W}from"./Bby8bbry.js";import{_ as Y}from"./D-r7qE1M.js";import{_ as ee}from"./BnJdxWF_.js";const pe={__name:"VPlaceLoad",props:["width","height","classes","light"],setup(e){const a=b("loads"),{width:t,height:m,classes:r,light:c}=e;return te(()=>{a.value=c?"loads-light":"loads"}),(_,w)=>(s(),h("div",{class:v(`${u(a)} ${e.classes}`),style:de({width:e.width,height:e.height,"max-width":"100%"})},null,6))}},ge=$(pe,[["__scopeId","data-v-b62404ca"]]),ve=(e,a)=>{const t=new Image;t.src=e,t.complete?a(!0):(t.onload=()=>a(!0),t.onerror=()=>a(!1))};var ke=function(a){var t=a.dt;return`
.p-skeleton {
    overflow: hidden;
