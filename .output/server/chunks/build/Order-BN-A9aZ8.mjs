...
import { u as useI18n, r as useRoute$1, a as useRuntimeConfig, _ as _export_sfc, l as navigateTo, q as __nuxt_component_0$1$1, c as useNuxtApp } from './server.mjs';
import { u as useShoppingCartComposable } from './useShoppingCartComposable-BNc-JnUZ.mjs';
import { p as princedomORMap, b as useAccountType, c as useCurrency, u as useCart, d as useLang } from './useState-4PtMRSTy.mjs';
import { ref, withAsyncContext, watchEffect, unref, useSSRContext, withCtx, createVNode, toDisplayString, resolveComponent, mergeProps, openBlock, createBlock, createTextVNode, createCommentVNode, Fragment, renderList } from 'vue';
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(_attrs)} data-v-ff77adc2><div class="table-content table-responsive" id="cart-container" data-v-ff77adc2><table class="table" data-v-ff77adc2><thead class="${ssrRenderClass([_ctx.$i18n.locale == "en" ? "headen" : "headar", "tabel-title"])}" data-v-ff77adc2><tr data-v-ff77adc2><th data-v-ff77adc2>${ssrInterpolate(_ctx.$i18n.locale == "ar" ? "\u0627\u0644\u0635\u0648\u0631\u0629" : "Photo")}</th><th data-v-ff77adc2>${ssrInterpolate(_ctx.$i18n.locale == "ar" ? "\u0627\u0644\u0627\u0633\u0645" : "Name")}</th><th data-v-ff77adc2>${ssrInterpolate(_ctx.$i18n.locale == "ar" ? "\u0627\u0644\u0643\u0645\u064A\u0629" : "Quantity")}</th><th data-v-ff77adc2>${ssrInterpolate(_ctx.$i18n.locale == "ar" ? "\u0627\u0644\u0633\u0639\u0631" : "Price")}</th></tr></thead><tbody data-v-ff77adc2><!--[-->`);
      ssrRenderList(__props.cart.items, (item, index) => {
        var _a2;
        _push(`<!--[-->`);
        if (item) {
          _push(`<tr data-v-ff77adc2><td data-v-ff77adc2><img class="product-img"${ssrRenderAttr("src", `${unref(apiBase)}/${(_a2 = item.item) == null ? void 0 : _a2.photos[0].photoPath}`)} alt="" width="75" height="50" data-v-ff77adc2></td><td data-v-ff77adc2>`);
          if (item.item.id) {
            _push(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<h6${ssrRenderAttr("title", ("useTranslate" in _ctx ? _ctx.useTranslate : unref(useTranslate))(item.item, "name"))} data-v-ff77adc2${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale == "en" ? item.item.plant_name : item.item.plant_name)}</h6>`);
                } else {
                  return [
                    createVNode("h6", {
          ...
          _push(`</td><td data-v-ff77adc2>`);
          _push(ssrRenderComponent(_component_font_awesome, {
            onClick: ($event) => increaseQty(item.id),
            icon: ["fas", "angle-up"],
            style: { "cursor": "pointer" }
          }, null, _parent));
          _push(`<span class="m-2 quantity text-black"${ssrRenderAttr("id", `quantity_${item.id}`)}${ssrRenderAttr("data-qty", item.qty)} data-v-ff77adc2>${ssrInterpolate(item.qty)}</span>`);
          _push(ssrRenderComponent(_component_font_awesome, {
            style: { "cursor": "pointer" },
            onClick: ($event) => decreaseQty(item.id),
            icon: ["fas", "angle-down"]
          }, null, _parent));
          _push(`</td><td data-v-ff77adc2>${ssrInterpolate((item.qty * item.price).toFixed(2))} ${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u062F\u0631\u0647\u0645 \u0625\u0645\u0627\u0631\u0627\u062A\u064A" : "AED")}</td></tr>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<!--]-->`);
      });
      _push(`<!--]--><tr data-v-ff77adc2><td class="py-3 text-center" colspan="1" data-v-ff77adc2><strong class="mb-0" data-v-ff77adc2>${ssrInterpolate(_ctx.$i18n.locale == "ar" ? "\u0627\u0644\u0633\u0639\u0631 \u0627\u0644\u0625\u062C\u0645\u0627\u0644\u064A" : "Total Price")}</strong></td><td colspan="1" data-v-ff77adc2></td><td colspan="1" data-v-ff77adc2></td><td class="py-3" data-v-ff77adc2><strong class="mb-0" data-v-ff77adc2>${ssrInterpolate((_a = __props.cart.totalPrice) == null ? void 0 : _a.toFixed(2))} ${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u062F\u0631\u0647\u0645 \u0625\u0645\u0627\u0631\u0627\u062A\u064A" : "AED")}</strong></td></tr></tbody></table></div></section>`);
    };
  }
};
...
const __nuxt_component_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-ff77adc2"]]);
const _sfc_main$4 = {
  __name: "VTextInput",
  __ssrInlineRender: true,
  props: {
...
const _sfc_main$2 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "user-info" }, _attrs))} data-v-e281e3d2><div class="row" data-v-e281e3d2><div class="col-12" data-v-e281e3d2><h4 class="mt-5 text-white text-center text-sm-start" data-v-e281e3d2>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0645\u0639\u0644\u0648\u0645\u0627\u062A \u0627\u0644\u0645\u0633\u062A\u062E\u062F\u0645" : "user Information")}</h4></div><div class="col-lg-6" data-v-e281e3d2>`);
      ...
      _push(`</div><div class="col-lg-6" data-v-e281e3d2>`);
      _push(ssrRenderComponent(_component_ElementsFormVTextInput, {
        border_color: "003d2ec2",
        color: "003d2ec2",
        type: "text",
      ...
      _push(`</div><div class="col-lg-6" data-v-e281e3d2><label for="buttondisplay" class="fw-bold d-block color" style="${ssrRenderStyle({ "margin-bottom": "-16px", "color": "#003d2ec2" })}" data-v-e281e3d2>${ssrInterpolate(_ctx.$t("City"))}</label>`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-e281e3d2"]]);
const _sfc_main$1 = {
  __name: "index",
  __ssrInlineRender: true,
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "order nav-margin" }, _attrs))} data-v-85405266><div class="container" data-v-85405266><div class="title" data-v-85405266><h1 class="d-flex align-items-center justify-content-center" data-v-85405266><img width="70"${ssrRenderAttr("src", _imports_0)} alt="" data-v-85405266><span class="underline" data-v-85405266>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0639\u0645\u0644\u064A\u0629 \u0627\u0644\u0637\u0644\u0628" : "Checkout")}</span></h1></div><div class="row" data-v-85405266><div class="col-md-12" data-v-85405266><h4 class="my-3 text-center text-white text-sm-start" data-v-85405266>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0645\u0639\u0644\u0648\u0645\u0627\u062A \u0627\u0644\u0645\u0646\u062A\u062C" : "Product Information")}</h4>`);
      ...
      _push(ssrRenderComponent(_component_VForm, {
        ...
        default: withCtx(({ meta: formMeta, values }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div data-v-85405266${_scopeId}>`);
            if (unref(hasError)) {
              _push2(`<div class="error-messages mb-3" data-v-85405266${_scopeId}><div class="alert alert-danger text-center" data-v-85405266${_scopeId}><ul class="list-unstyled mb-0" data-v-85405266${_scopeId}><!--[-->`);
              ssrRenderList(unref(errorMessage), (error, index) => {
                _push2(`<li data-v-85405266${_scopeId}>${ssrInterpolate(error)}</li>`);
              });
              _push2(`<!--]--></ul></div></div>`);
            } else {
              _push2(`<!---->`);
            ...
            _push2(`<div style="${ssrRenderStyle({ "height": "50vh", "width": "100%", "margin": "auto", "z-index": "10" })}" data-v-85405266${_scopeId}>`);
            _push2(ssrRenderComponent(_component_ClientOnly, null, {}, _parent2, _scopeId));
            _push2(`</div><div class="col-md-12 form-group mt-4 d-flex justify-content-center justify-content-sm-start" data-v-85405266${_scopeId}><button type="submit" value="Login" class="${ssrRenderClass([{ background: formMeta.valid }, "background btn px-10 py-2 text-black w-50 btn-block m-auto"])}" data-v-85405266${_scopeId}>`);
            if (!unref(isLoading)) {
              _push2(`<span class="text-white" data-v-85405266${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0623\u0637\u0644\u0628 \u0627\u0644\u0622\u0646" : "Order Now")}</span>`);
            } else {
              _push2(`<span class="text-black" data-v-85405266${_scopeId}>${ssrInterpolate(_ctx.$t("loading..."))}</span>`);
            }
            _push2(`</button></div>`);
          } else {
            return [
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-85405266"]]);
const _sfc_main = {
  __name: "Order",
  __ssrInlineRender: true,
  async setup(__props) {
...
//# sourceMappingURL=Order-BN-A9aZ8.mjs.map
