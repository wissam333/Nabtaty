...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  }, _attrs))} data-v-bce4e8c4><div class="${ssrRenderClass([("useSidebar" in _ctx ? _ctx.useSidebar : unref(useSidebar))().value ? "shrink" : "", "mainImg"])}" data-v-bce4e8c4><img${ssrRenderAttr("src", _imports_0$1)} alt="" data-v-bce4e8c4></div></div>`);
}
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-bce4e8c4"]]);
const _sfc_main = {
  __name: "index",
...
//# sourceMappingURL=index-VPmEA9Gh.mjs.map
