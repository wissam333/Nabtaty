...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="${ssrRenderClass([("useSidebar" in _ctx ? _ctx.useSidebar : unref(useSidebar))().value ? "shrink" : "", "contain"])}" data-v-b68556c2><div class="title-container" data-v-b68556c2><div class="head-title" data-v-b68556c2><h4 class="header4" data-v-b68556c2>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0642\u0627\u0626\u0645\u0629 \u0627\u0644\u0645\u0646\u0627\u0637\u0642" : "Regions List")}</h4></div><div class="options" data-v-b68556c2><div class="reload btn btn-success mx-2" data-v-b68556c2>`);
      _push(ssrRenderComponent(_component_font_awesome, { icon: ["fas", "plus"] }, null, _parent));
      _push(` ${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0625\u0636\u0627\u0641\u0629" : "Add")}</div><div class="reload btn btn-success" data-v-b68556c2>`);
      _push(ssrRenderComponent(_component_font_awesome, { icon: ["fas", "rotate-right"] }, null, _parent));
      _push(` ${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0625\u0639\u0627\u062F\u0629 \u062A\u062D\u0645\u064A\u0644" : "Reload")}</div></div></div><div class="table-responsive" data-v-b68556c2>`);
      if (unref(loading)) {
        _push(`<div class="loading" data-v-b68556c2><img${ssrRenderAttr("src", _imports_0)} alt="" data-v-b68556c2></div>`);
      } else {
        _push(`<div class="product-tabel" data-v-b68556c2><table data-v-b68556c2><thead data-v-b68556c2><tr data-v-b68556c2><th data-v-b68556c2>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0627\u0633\u0645" : "Name")}</th><th data-v-b68556c2>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0633\u0639\u0631" : "Price")}</th><th data-v-b68556c2>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u062A\u0639\u062F\u064A\u0644" : "Edit")}</th></tr></thead><tbody data-v-b68556c2><!--[-->`);
        ssrRenderList(unref(Loactions), (product) => {
          _push(`<tr class="rows" data-v-b68556c2><td class="d-flex align-items-center" data-v-b68556c2><h5 class="fw-bold" data-v-b68556c2>${ssrInterpolate(product.name)}</h5></td><td class="fw-bold" data-v-b68556c2>JOD ${ssrInterpolate(product.price)}</td><td data-v-b68556c2><span class="delete" data-v-b68556c2>`);
          _push(ssrRenderComponent(_component_font_awesome, { icon: ["fas", "trash"] }, null, _parent));
          _push(`</span><span class="edit-link" data-v-b68556c2><span class="edit" data-v-b68556c2>`);
      ...
      _push(ssrRenderComponent(_component_Dialog, {
        ...
        container: withCtx(({ closeCallback }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="dialog"${ssrRenderAttr("dir", _ctx.$i18n.locale === "ar" ? "rtl" : "ltr")} data-v-b68556c2${_scopeId}><h5 data-v-b68556c2${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0625\u0636\u0627\u0641\u0629 \u0645\u0646\u0637\u0642\u0629 \u062C\u062F\u064A\u062F\u0629" : "Add New Region")}</h5><div class="content" data-v-b68556c2${_scopeId}><div data-v-b68556c2${_scopeId}><div class="d-flex flex-column-reverse mb-3" data-v-b68556c2${_scopeId}><input${ssrRenderAttr("value", unref(nameAr))} id="nameAr" type="text" required autocomplete="off"${ssrRenderAttr(
              "placeholder",
              _ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0627\u0633\u0645 \u0628\u0627\u0644\u0639\u0631\u0628\u064A" : "Arabic Name"
            )} title="Enter only letters and spaces" data-v-b68556c2${_scopeId}><label for="nameAr" data-v-b68556c2${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0627\u0633\u0645 \u0628\u0627\u0644\u0639\u0631\u0628\u064A" : "Arabic Name")}</label></div><div class="d-flex flex-column-reverse mb-3" data-v-b68556c2${_scopeId}><input${ssrRenderAttr("value", unref(nameEn))} id="nameEn" type="text" required autocomplete="off"${ssrRenderAttr(
              "placeholder",
              _ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0627\u0633\u0645 \u0628\u0627\u0644\u0627\u0646\u062C\u0644\u064A\u0632\u064A" : "English Name"
            )} data-v-b68556c2${_scopeId}><label for="nameEn" data-v-b68556c2${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0627\u0633\u0645 \u0628\u0627\u0644\u0627\u0646\u062C\u0644\u064A\u0632\u064A" : "English Name")}</label></div><div class="d-flex flex-column-reverse mb-3" data-v-b68556c2${_scopeId}><input${ssrRenderAttr("value", unref(price))} id="price" type="number" required maxlength="6" min="0"${ssrRenderAttr("placeholder", _ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0633\u0639\u0631" : "Price")} data-v-b68556c2${_scopeId}><label for="price" data-v-b68556c2${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0633\u0639\u0631" : "Price")}</label></div></div></div><div class="mt-5 d-flex w-100 justify-content-end" data-v-b68556c2${_scopeId}><button class="btn btn-secondary" data-v-b68556c2${_scopeId}>${ssrInterpolate(_ctx.$t("Close"))}</button><button class="btn btn-success mx-2" autofocus data-v-b68556c2${_scopeId}>${ssrInterpolate(_ctx.$t("Add"))}</button></div></div>`);
          } else {
            return [
              createVNode("div", {
                class: "dialog",
      ...
      _push(ssrRenderComponent(_component_Dialog, {
        ...
        container: withCtx(({ closeCallback }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="dialog"${ssrRenderAttr("dir", _ctx.$i18n.locale === "ar" ? "rtl" : "ltr")} data-v-b68556c2${_scopeId}><h5 data-v-b68556c2${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u062A\u0639\u062F\u064A\u0644 \u0627\u0644\u0645\u0646\u0637\u0642\u0629" : "Edit Region")}</h5><div class="content" data-v-b68556c2${_scopeId}><div data-v-b68556c2${_scopeId}><div class="d-flex flex-column-reverse mb-3" data-v-b68556c2${_scopeId}><input${ssrRenderAttr("value", unref(editnameAr))} id="editnameAr" type="text" required autocomplete="off"${ssrRenderAttr(
              "placeholder",
              _ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0627\u0633\u0645 \u0628\u0627\u0644\u0639\u0631\u0628\u064A" : "Arabic Name"
            )} title="Enter only letters and spaces" data-v-b68556c2${_scopeId}><label for="editnameAr" data-v-b68556c2${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0627\u0633\u0645 \u0628\u0627\u0644\u0639\u0631\u0628\u064A" : "Arabic Name")}</label></div><div class="d-flex flex-column-reverse mb-3" data-v-b68556c2${_scopeId}><input${ssrRenderAttr("value", unref(editnameEn))} id="editnameEn" type="text" required autocomplete="off"${ssrRenderAttr(
              "placeholder",
              _ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0627\u0633\u0645 \u0628\u0627\u0644\u0627\u0646\u062C\u0644\u064A\u0632\u064A" : "English Name"
            )} data-v-b68556c2${_scopeId}><label for="editnameEn" data-v-b68556c2${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0627\u0633\u0645 \u0628\u0627\u0644\u0627\u0646\u062C\u0644\u064A\u0632\u064A" : "English Name")}</label></div><div class="d-flex flex-column-reverse mb-3" data-v-b68556c2${_scopeId}><input${ssrRenderAttr("value", unref(editPrice))} id="price" type="number" required maxlength="6" min="0"${ssrRenderAttr("placeholder", _ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0633\u0639\u0631" : "Price")} data-v-b68556c2${_scopeId}><label for="price" data-v-b68556c2${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0633\u0639\u0631" : "Price")}</label></div></div></div><div class="mt-5 d-flex w-100 justify-content-end" data-v-b68556c2${_scopeId}><button class="btn btn-secondary" data-v-b68556c2${_scopeId}>${ssrInterpolate(_ctx.$t("Close"))}</button><button class="btn btn-success mx-2" autofocus data-v-b68556c2${_scopeId}>${ssrInterpolate(_ctx.$t("Edit"))}</button></div></div>`);
          } else {
            return [
              createVNode("div", {
                class: "dialog",
      ...
      _push(ssrRenderComponent(_component_ElementsAppModal, {
        ...
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h4 data-v-b68556c2${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u062A\u0623\u0643\u064A\u062F \u0627\u0644\u062D\u0630\u0641" : "Confirm Delete")}</h4>`);
          } else {
            return [
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p data-v-b68556c2${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0645\u0646 \u0623\u0646\u0643 \u062A\u0631\u064A\u062F \u062D\u0630\u0641" : "Are You Sure You Want To Delete")} &quot;${ssrInterpolate(unref(deleteRegion).name)}&quot;${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u061F" : "?")}</p>`);
          } else {
            return [
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button class="btn btn-secondary" data-v-b68556c2${_scopeId}>${ssrInterpolate(_ctx.$t("Close"))}</button><button class="btn btn-danger" data-v-b68556c2${_scopeId}>${ssrInterpolate(_ctx.$t("Delete"))}</button>`);
          } else {
            return [
              createVNode("button", {
                class: "btn btn-secondary",
...
const Locations = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b68556c2"]]);

export { Locations as default };
//# sourceMappingURL=Locations-zjOVZ6Fa.mjs.map
