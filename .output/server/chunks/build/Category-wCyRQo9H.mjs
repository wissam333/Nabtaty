...
import { _ as __nuxt_component_1 } from './AppModal-CyoBj_7p.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="${ssrRenderClass([("useSidebar" in _ctx ? _ctx.useSidebar : unref(useSidebar))().value ? "shrink" : "", "contain"])}" data-v-25cf99f6><div class="title-container" data-v-25cf99f6><div class="head-title" data-v-25cf99f6><h4 class="header4" data-v-25cf99f6>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0642\u0627\u0626\u0645\u0629 \u0627\u0644\u0641\u0626\u0627\u062A" : "Categories List")}</h4></div><div class="options" data-v-25cf99f6><div class="reload btn btn-success mx-2" data-v-25cf99f6>`);
      _push(ssrRenderComponent(_component_font_awesome, { icon: ["fas", "plus"] }, null, _parent));
      _push(` ${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0625\u0636\u0627\u0641\u0629" : "Add")}</div><div class="reload btn btn-success" data-v-25cf99f6>`);
      _push(ssrRenderComponent(_component_font_awesome, { icon: ["fas", "rotate-right"] }, null, _parent));
      _push(` ${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0625\u0639\u0627\u062F\u0629 \u062A\u062D\u0645\u064A\u0644" : "Reload")}</div></div></div><div class="table-responsive" data-v-25cf99f6>`);
      if (unref(loading)) {
        _push(`<div class="loading" data-v-25cf99f6><img${ssrRenderAttr("src", _imports_0)} alt="" data-v-25cf99f6></div>`);
      } else {
        _push(`<div class="cat-tabel" data-v-25cf99f6><table data-v-25cf99f6><thead data-v-25cf99f6><tr data-v-25cf99f6><th data-v-25cf99f6>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0627\u0633\u0645" : "Name")}</th><th data-v-25cf99f6>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u062A\u0639\u062F\u064A\u0644" : "Edit")}</th></tr></thead><tbody data-v-25cf99f6><!--[-->`);
        ssrRenderList(unref(cats), (cat) => {
          _push(`<tr class="rows" data-v-25cf99f6><td class="d-flex align-items-center" data-v-25cf99f6><div class="cat-img mx-2" data-v-25cf99f6>`);
          if (cat.photo) {
            _push(`<img${ssrRenderAttr("src", unref(apiBase) + "/" + cat.photo)} alt="" data-v-25cf99f6>`);
          } else {
            _push(`<img${ssrRenderAttr("src", _imports_1)} alt="" data-v-25cf99f6>`);
          }
          _push(`</div><div class="cat-info d-flex flex-column align-items-start" data-v-25cf99f6><h5 data-v-25cf99f6>${ssrInterpolate(cat.category_name)}</h5></div></td><td data-v-25cf99f6><span class="delete" data-v-25cf99f6>`);
          _push(ssrRenderComponent(_component_font_awesome, { icon: ["fas", "trash"] }, null, _parent));
          _push(`</span><span class="edit-link" data-v-25cf99f6><span class="edit" data-v-25cf99f6>`);
      ...
      _push(ssrRenderComponent(_component_Dialog, {
        ...
        container: withCtx(({ closeCallback }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="dialog"${ssrRenderAttr("dir", _ctx.$i18n.locale === "ar" ? "rtl" : "ltr")} data-v-25cf99f6${_scopeId}><h5 data-v-25cf99f6${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0625\u0636\u0627\u0641\u0629 \u0641\u0626\u0629 \u062C\u062F\u064A\u062F\u0629" : "Add New Category")}</h5><div class="content" data-v-25cf99f6${_scopeId}><div data-v-25cf99f6${_scopeId}><div class="d-flex flex-column-reverse mb-3" data-v-25cf99f6${_scopeId}><input${ssrRenderAttr("value", unref(titleAr))} id="titleAr" type="text" autocomplete="off"${ssrRenderAttr(
              "placeholder",
              _ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0627\u0633\u0645 \u0628\u0627\u0644\u0644\u063A\u0629 \u0627\u0644\u0639\u0631\u0628\u064A\u0629" : "Name In Arabic"
            )} title="Enter only letters and spaces" required data-v-25cf99f6${_scopeId}><label for="titleAr" data-v-25cf99f6${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0627\u0633\u0645 \u0628\u0627\u0644\u0644\u063A\u0629 \u0627\u0644\u0639\u0631\u0628\u064A\u0629" : "Name In Arabic")}</label></div><div class="d-flex flex-column-reverse mb-3" data-v-25cf99f6${_scopeId}><input${ssrRenderAttr("value", unref(titleEn))} id="titleEn" type="text" autocomplete="off"${ssrRenderAttr(
              "placeholder",
              _ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0627\u0633\u0645 \u0628\u0627\u0644\u0644\u063A\u0629 \u0627\u0644\u0627\u0646\u062C\u0644\u064A\u0632\u064A\u0629" : "Name In English"
            )} required title="Enter only letters and spaces" data-v-25cf99f6${_scopeId}><label for="titleEn" data-v-25cf99f6${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0627\u0633\u0645 \u0628\u0627\u0644\u0644\u063A\u0629 \u0627\u0644\u0627\u0646\u062C\u0644\u064A\u0632\u064A\u0629" : "Name In English")}</label></div><div class="drop-area my-4" data-v-25cf99f6${_scopeId}><div class="upload-box" data-v-25cf99f6${_scopeId}>`);
            ...
            if (unref(src)) {
              _push2(`<img${ssrRenderAttr("src", unref(src))} alt="Image" class="shadow-md w-100 h-100 sm:w-64" data-v-25cf99f6${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            if (unref(src)) {
              _push2(`<button class="btn btn-danger clear" data-v-25cf99f6${_scopeId}>`);
            ...
            _push2(`</div></div></div></div><div class="mt-5 d-flex w-100 justify-content-end" data-v-25cf99f6${_scopeId}><button class="btn btn-secondary" data-v-25cf99f6${_scopeId}>${ssrInterpolate(_ctx.$t("Close"))}</button><button class="btn btn-success mx-2" autofocus data-v-25cf99f6${_scopeId}>${ssrInterpolate(_ctx.$t("Add"))}</button></div></div>`);
          } else {
            return [
              createVNode("div", {
                class: "dialog",
      ...
      _push(ssrRenderComponent(_component_Dialog, {
        ...
        container: withCtx(({ closeCallback }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="dialog"${ssrRenderAttr("dir", _ctx.$i18n.locale === "ar" ? "rtl" : "ltr")} data-v-25cf99f6${_scopeId}><h5 data-v-25cf99f6${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u062A\u0639\u062F\u064A\u0644 \u0641\u0626\u0629" : "Edit Category")}</h5><div class="content" data-v-25cf99f6${_scopeId}><div data-v-25cf99f6${_scopeId}><div class="d-flex flex-column-reverse mb-3" data-v-25cf99f6${_scopeId}><input${ssrRenderAttr("value", unref(edittitleAr))} id="edittitleAr" type="text" autocomplete="off"${ssrRenderAttr(
              "placeholder",
              _ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0627\u0633\u0645 \u0628\u0627\u0644\u0644\u063A\u0629 \u0627\u0644\u0639\u0631\u0628\u064A\u0629" : "Name In Arabic"
            )} title="Enter only letters and spaces" required data-v-25cf99f6${_scopeId}><label for="edittitleAr" data-v-25cf99f6${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0627\u0633\u0645 \u0628\u0627\u0644\u0644\u063A\u0629 \u0627\u0644\u0639\u0631\u0628\u064A\u0629" : "Name In Arabic")}</label></div><div class="d-flex flex-column-reverse mb-3" data-v-25cf99f6${_scopeId}><input${ssrRenderAttr("value", unref(edittitleEn))} id="edittitleEn" type="text" autocomplete="off"${ssrRenderAttr(
              "placeholder",
              _ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0627\u0633\u0645 \u0628\u0627\u0644\u0644\u063A\u0629 \u0627\u0644\u0627\u0646\u062C\u0644\u064A\u0632\u064A\u0629" : "Name In English"
            )} required title="Enter only letters and spaces" data-v-25cf99f6${_scopeId}><label for="edittitleEn" data-v-25cf99f6${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0627\u0633\u0645 \u0628\u0627\u0644\u0644\u063A\u0629 \u0627\u0644\u0627\u0646\u062C\u0644\u064A\u0632\u064A\u0629" : "Name In English")}</label></div><div class="drop-area my-4" data-v-25cf99f6${_scopeId}><div class="upload-box" data-v-25cf99f6${_scopeId}>`);
            _push2(ssrRenderComponent(_component_FileUpload, {
              mode: "basic",
            ...
            if (unref(editsrc)) {
              _push2(`<img${ssrRenderAttr("src", unref(editsrc))} alt="Image" class="shadow-md w-100 h-100 sm:w-64" data-v-25cf99f6${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            if (unref(editsrc)) {
            ...
            _push2(`</div></div></div></div><div class="mt-5 d-flex w-100 justify-content-end" data-v-25cf99f6${_scopeId}><button class="btn btn-secondary" data-v-25cf99f6${_scopeId}>${ssrInterpolate(_ctx.$t("Close"))}</button><button class="btn btn-success mx-2" autofocus data-v-25cf99f6${_scopeId}>${ssrInterpolate(_ctx.$t("Edit"))}</button></div></div>`);
          } else {
            return [
              createVNode("div", {
                class: "dialog",
      ...
      _push(ssrRenderComponent(_component_ElementsAppModal, {
        ...
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h4 data-v-25cf99f6${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u062A\u0623\u0643\u064A\u062F \u0627\u0644\u062D\u0630\u0641" : "Confirm Delete")}</h4>`);
          } else {
            return [
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p data-v-25cf99f6${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0645\u0646 \u0623\u0646\u0643 \u062A\u0631\u064A\u062F \u062D\u0630\u0641" : "Are You Sure You Want To Delete")} &quot;${ssrInterpolate(unref(deleteRegion).category_name)}&quot;${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u061F" : "?")}</p>`);
          } else {
            return [
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button class="btn btn-secondary" data-v-25cf99f6${_scopeId}>${ssrInterpolate(_ctx.$t("Close"))}</button><button class="btn btn-danger" data-v-25cf99f6${_scopeId}>${ssrInterpolate(_ctx.$t("Delete"))}</button>`);
          } else {
            return [
              createVNode("button", {
                class: "btn btn-secondary",
...
const Category = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-25cf99f6"]]);

export { Category as default };
//# sourceMappingURL=Category-wCyRQo9H.mjs.map
