...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container-fluid nav-margin" }, _attrs))} data-v-99076d4f><div class="title" data-v-99076d4f><h1 class="d-flex align-items-center justify-content-center" data-v-99076d4f><img width="70"${ssrRenderAttr("src", _imports_0)} alt="" data-v-99076d4f><span class="underline" data-v-99076d4f>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0646\u062A\u0627\u0626\u062C \u0627\u0644\u0628\u062D\u062B" : "Search Result")}</span></h1></div>`);
      if (unref(pending)) {
        _push(`<div class="d-flex justify-center align-items-center" style="${ssrRenderStyle({ "height": "500px" })}" data-v-99076d4f>`);
        _push(ssrRenderComponent(_component_ElementsSpinner, null, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<div data-v-99076d4f>`);
        if (unref(Products)) {
          _push(`<div data-v-99076d4f>`);
          if (unref(Products).data.length > 0) {
            _push(`<div class="row" data-v-99076d4f><!--[-->`);
            ssrRenderList(unref(Products).data, (item) => {
              _push(`<div class="mb-4 col-6 col-sm-6 col-md-3 col-lg-3" data-v-99076d4f>`);
            ...
            _push(`<div class="d-flex justify-center align-items-center" style="${ssrRenderStyle({ "height": "400px" })}" data-v-99076d4f><h1 class="color fw-bold" data-v-99076d4f>${ssrInterpolate(_ctx.$i18n.locale == "ar" ? "\u0646\u0639\u062A\u0630\u0631 \u0644\u0627 \u064A\u0648\u062C\u062F \u0645\u0646\u062A\u062C\u0627\u062A" : "Sorry No Items")}</h1></div>`);
          }
          _push(`</div>`);
        } else {
          _push(`<!---->`);
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-99076d4f"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-C_uhOKii.mjs.map
