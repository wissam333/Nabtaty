import { _ as __nuxt_component_1$1 } from './Spinner-CLt5-saY.mjs';
import { Swiper, SwiperSlide } from 'swiper/vue';
import { p as publicAssetsURL, B as BaseStyle, _ as _export_sfc, i as useI18n, u as useRuntimeConfig } from './server.mjs';
import { u as useFetch } from './fetch-BFEkLjmZ.mjs';
import { useSSRContext, withAsyncContext, ref, mergeProps, unref, withCtx, createVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, watchEffect, createTextVNode, createElementBlock, createElementVNode, renderSlot, normalizeClass, resolveDynamicComponent } from 'vue';
...
import { s as script$5, U as UniqueComponentId, a as script$1$1 } from './index-DR0EbPSo.mjs';
...
const _sfc_main$b = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "home" }, _attrs))} data-v-4b5847f3><div class="slider" data-v-4b5847f3>`);
      if (unref(pending)) {
        _push(`<div class="text-center text-white loader" data-v-4b5847f3>`);
        _push(ssrRenderComponent(_component_ElementsSpinner, null, null, _parent));
        _push(`</div>`);
      } else if (!unref(pending)) {
        _push(`<div data-v-4b5847f3>`);
              ...
              ssrRenderList(unref(MainImg), (image) => {
                _push2(ssrRenderComponent(_component_SwiperSlide, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<div class="main-img" data-v-4b5847f3${_scopeId2}><img class="main"${ssrRenderAttr("src", `${unref(apiBase)}/${image.photo}`)} data-v-4b5847f3${_scopeId2}></div>`);
                    } else {
                      return [
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-4b5847f3"]]);
...
const __nuxt_component_3$1 = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-3103affe"]]);
const _sfc_main$9 = {
  __name: "Categories",
  __ssrInlineRender: true,
  async setup(__props) {
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-7ee01ace"]]);
const _imports_1$1 = publicAssetsURL("/photos/2619fafceaedd791a39fd2a196ec0641.png");
const _sfc_main$8 = {
  __name: "ProductCard",
  __ssrInlineRender: true,
  props: ["product", "productId"],
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_nuxt_link = __nuxt_component_2$1;
      _push(`<!--[--><div class="leaf" data-v-213bca8e><img${ssrRenderAttr("src", _imports_0$3)} alt="" data-v-213bca8e></div><div class="leaf2" data-v-213bca8e><img${ssrRenderAttr("src", _imports_0$3)} alt="" data-v-213bca8e></div><div class="leaf3" data-v-213bca8e><img${ssrRenderAttr("src", _imports_0$3)} alt="" data-v-213bca8e></div><div class="leaf4" data-v-213bca8e><img${ssrRenderAttr("src", _imports_0$3)} alt="" data-v-213bca8e></div>`);
      if ((_b = (_a = __props.product) == null ? void 0 : _a.data) == null ? void 0 : _b.productOffer.discountRatio) {
      ...
      if ((_e = __props.product) == null ? void 0 : _e.photos.photoPath) {
        ...
        _push(`<img${ssrRenderAttr("src", _imports_1$1)} alt="" data-v-213bca8e>`);
      }
...
const __nuxt_component_4$2 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-213bca8e"]]);
const _sfc_main$7 = {
  __name: "Arrivals",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["Categories", _ctx.$i18n.locale === "ar" ? "ar" : ""]
      }, _attrs))} data-v-542ae40f><div class="container mt-10" data-v-542ae40f><div class="see-all" data-v-542ae40f>`);
      _push(ssrRenderComponent(_component_nuxt_link, {
        to: `/Products/11`,
        class: "btn"
      }, {
      ...
      _push(`</div><h1 data-v-542ae40f><img width="70"${ssrRenderAttr("src", _imports_0$2)} alt="" data-v-542ae40f><span data-v-542ae40f>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0646\u0628\u0627\u062A\u0627\u062A \u062E\u0636\u0631\u0627\u0621" : "Green Plants")}</span></h1>`);
      if (unref(loading)) {
        _push(`<div class="text-center text-white loader" data-v-542ae40f>`);
        _push(ssrRenderComponent(_component_ElementsSpinner, null, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<div data-v-542ae40f>`);
        _push(ssrRenderComponent(_component_Swiper, {
          style: { "direction": "ltr" },
          modules: ["SwiperAutoplay" in _ctx ? _ctx.SwiperAutoplay : unref(Autoplay), "SwiperPagination" in _ctx ? _ctx.SwiperPagination : unref(Pagination)],
          loop: false,
            ...
            if (_push2) {
              ...
              ssrRenderList(unref(Products), (product) => {
                _push2(ssrRenderComponent(_component_SwiperSlide, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<div class="product"${ssrRenderAttr("dir", _ctx.$i18n.locale === "ar" ? "rtl" : "ltr")} data-aos="fade-up" data-aos-duration="800" data-v-542ae40f${_scopeId2}>`);
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-542ae40f"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if ((_a = unref(Products)) == null ? void 0 : _a.length) {
        _push(`<div${ssrRenderAttrs(mergeProps({
          class: ["Categories", _ctx.$i18n.locale === "ar" ? "ar" : ""]
        }, _attrs))} data-v-d6e8afaf><div class="container mt-10" data-v-d6e8afaf><div class="see-all" data-v-d6e8afaf>`);
        _push(ssrRenderComponent(_component_nuxt_link, {
          to: `/Products/16`,
          class: "btn"
        }, {
        ...
        _push(`</div><h1 data-v-d6e8afaf><img width="70"${ssrRenderAttr("src", _imports_0$2)} alt="" data-v-d6e8afaf><span data-v-d6e8afaf>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0647\u062F\u0627\u064A\u0627" : "Gifts")}</span></h1>`);
        if (unref(loading)) {
          _push(`<div class="text-center text-white loader" data-v-d6e8afaf>`);
          _push(ssrRenderComponent(_component_ElementsSpinner, null, null, _parent));
          _push(`</div>`);
        } else {
          _push(`<div data-v-d6e8afaf>`);
          _push(ssrRenderComponent(_component_Swiper, {
            style: { "direction": "ltr" },
            modules: ["SwiperAutoplay" in _ctx ? _ctx.SwiperAutoplay : unref(Autoplay), "SwiperPagination" in _ctx ? _ctx.SwiperPagination : unref(Pagination)],
            loop: false,
              ...
              if (_push2) {
                ...
                ssrRenderList(unref(Products), (product) => {
                  _push2(ssrRenderComponent(_component_SwiperSlide, {
                    ...
                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                      if (_push3) {
                        _push3(`<div class="product"${ssrRenderAttr("dir", _ctx.$i18n.locale === "ar" ? "rtl" : "ltr")} data-aos="fade-up" data-aos-duration="800" data-v-d6e8afaf${_scopeId2}>`);
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-d6e8afaf"]]);
const _imports_1 = publicAssetsURL("/photos/rose.png");
const _sfc_main$4 = {
  __name: "About",
  __ssrInlineRender: true,
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(pending)) {
        ...
        _push(`</div></div><div class="about-img col-lg-6"${ssrRenderAttr("data-aos", _ctx.$i18n.locale === "ar" ? "fade-right" : "fade-left")} data-aos-duration="800" data-v-a4a826f1><img${ssrRenderAttr("src", _imports_1)} alt="" data-v-a4a826f1></div></div></div>`);
      }
      _push(`</div>`);
    };
  }
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-a4a826f1"]]);
const _sfc_main$3 = {
  __name: "Album",
  __ssrInlineRender: true,
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Swiper = Swiper;
      const _component_SwiperSlide = SwiperSlide;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "home container" }, _attrs))} data-v-6bbc2f6e><div class="title" data-v-6bbc2f6e><h1 class="d-flex align-items-center" data-v-6bbc2f6e><img width="70"${ssrRenderAttr("src", _imports_0$2)} alt="" data-v-6bbc2f6e><span class="underline" data-v-6bbc2f6e>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0628\u0648\u0645\u0646\u0627" : "Our Album")}</span></h1></div><div class="slider" data-v-6bbc2f6e>`);
      if (unref(pending)) {
        _push(`<div class="text-center text-white loader" data-v-6bbc2f6e>`);
        _push(ssrRenderComponent(_component_ElementsSpinner, null, null, _parent));
        _push(`</div>`);
      } else if (!unref(pending)) {
        _push(`<div data-v-6bbc2f6e>`);
        _push(ssrRenderComponent(_component_Swiper, {
          style: { "direction": "ltr" },
          modules: [
            ...
            if (_push2) {
              ...
              ssrRenderList(unref(Album), (photo) => {
                _push2(ssrRenderComponent(_component_SwiperSlide, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<div class="main-img" data-v-6bbc2f6e${_scopeId2}><img class="main"${ssrRenderAttr("src", unref(apiBase) + "/" + photo.photo)} data-v-6bbc2f6e${_scopeId2}></div>`);
                    } else {
                      return [
                        createVNode("div", { class: "main-img" }, [
                          createVNode("img", {
      ...
      _push(`</div><div class="swiper-navigation" data-v-6bbc2f6e><button class="swiper-button-next" data-v-6bbc2f6e></button><button class="swiper-button-prev" data-v-6bbc2f6e></button></div></div>`);
    };
  }
};
...
const __nuxt_component_5 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-6bbc2f6e"]]);
var script$4 = {
  name: "BanIcon",
  "extends": script$5
};
...
const __nuxt_component_6 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-5ee4e807"]]);
const _sfc_main$1 = {};
...
//# sourceMappingURL=index-BPuSRTAv.mjs.map
