...
import { _ as __nuxt_component_5$1 } from './ProductCard-C1B8AG00.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if ((_a = unref(Products)) == null ? void 0 : _a.length) {
        _push(`<div${ssrRenderAttrs(mergeProps({
          class: ["Categories", _ctx.$i18n.locale === "ar" ? "ar" : ""]
        }, _attrs))} data-v-1eafb722><div class="container mt-10" data-v-1eafb722><div class="see-all" data-v-1eafb722>`);
        _push(ssrRenderComponent(_component_nuxt_link, {
          to: `/Newest`,
          class: "btn"
        }, {
        ...
        _push(`</div><h1 data-v-1eafb722><img width="70"${ssrRenderAttr("src", _imports_0$2)} alt="" data-v-1eafb722><span data-v-1eafb722>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0648\u0635\u0644 \u062D\u062F\u064A\u062B\u0627" : "New Arrivals")}</span></h1>`);
        if (unref(loading)) {
          _push(`<div class="text-center text-white loader" data-v-1eafb722>`);
          _push(ssrRenderComponent(_component_ElementsSpinner, null, null, _parent));
          _push(`</div>`);
        } else {
          _push(`<div data-v-1eafb722>`);
          _push(ssrRenderComponent(_component_Swiper, {
            style: { "direction": "ltr" },
            modules: ["SwiperAutoplay" in _ctx ? _ctx.SwiperAutoplay : unref(Autoplay), "SwiperPagination" in _ctx ? _ctx.SwiperPagination : unref(Pagination)],
            loop: false,
              ...
              if (_push2) {
                ...
                ssrRenderList(unref(Products), (product) => {
                  _push2(ssrRenderComponent(_component_SwiperSlide, {
                    ...
                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                      if (_push3) {
                        _push3(`<div class="product"${ssrRenderAttr("dir", _ctx.$i18n.locale === "ar" ? "rtl" : "ltr")} data-aos="fade-up" data-aos-duration="800" data-v-1eafb722${_scopeId2}>`);
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-1eafb722"]]);
...
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[-->`);
      if ((_b = (_a = __props.product) == null ? void 0 : _a.data) == null ? void 0 : _b.productOffer.discountRatio) {
        _push(`<div class="disscount" data-v-93d250cb>${ssrInterpolate(((_d = (_c = __props.product) == null ? void 0 : _c.data) == null ? void 0 : _d.productOffer.discountRatio) + "%")}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="product-img" data-v-93d250cb>`);
      if ((_f = (_e = __props.product) == null ? void 0 : _e.photos) == null ? void 0 : _f.photoPath) {
        _push(`<img${ssrRenderAttr("src", unref(apiBase) + "/" + ((_h = (_g = __props.product) == null ? void 0 : _g.photos) == null ? void 0 : _h.photoPath))} alt="" data-v-93d250cb>`);
      } else {
        _push(`<img${ssrRenderAttr("src", _imports_0)} alt="" data-v-93d250cb>`);
      }
      _push(`</div><div class="product-info" data-v-93d250cb><h5 class="title" data-v-93d250cb>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? __props.product.plant_name : __props.product.plant_name)}</h5>`);
      _push(ssrRenderComponent(_component_nuxt_link, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span data-v-93d250cb${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0637\u0644\u0628 \u0627\u0644\u0622\u0646" : "Order Now")}</span>`);
          } else {
            return [
      ...
      _push(`<p class="price" data-v-93d250cb><span class="${ssrRenderClass(((_m = (_l = __props.product) == null ? void 0 : _l.productOffer) == null ? void 0 : _m.newPrice) ? "old-price" : "")}" data-v-93d250cb>${ssrInterpolate((_n = __props.product) == null ? void 0 : _n.price)} ${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "JOD" : "JOD")}</span></p>`);
      if ((_p = (_o = __props.product) == null ? void 0 : _o.productOffer) == null ? void 0 : _p.newPrice) {
        _push(`<p class="price" data-v-93d250cb>${ssrInterpolate((_r = (_q = __props.product) == null ? void 0 : _q.productOffer) == null ? void 0 : _r.newPrice)} ${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "JOD" : "JOD")}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><!--]-->`);
...
const __nuxt_component_4$1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-93d250cb"]]);
const _sfc_main$5 = {
  __name: "Gifts",
  __ssrInlineRender: true,
  setup(__props) {
...
const _sfc_main$4 = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ElementsSpinner = __nuxt_component_0$2;
      const _component_nuxt_link = __nuxt_component_2$1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "about" }, _attrs))} data-v-5e0b7199>`);
      if (unref(pending)) {
        _push(`<div class="text-center text-white" data-v-5e0b7199>`);
        _push(ssrRenderComponent(_component_ElementsSpinner, null, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<div class="container" data-v-5e0b7199><div class="about-content row" data-v-5e0b7199><div class="about-info col-lg-6"${ssrRenderAttr("data-aos", _ctx.$i18n.locale === "ar" ? "fade-left" : "fade-right")} data-aos-duration="800" data-v-5e0b7199><div class="title" data-v-5e0b7199><h1 class="d-flex align-items-center" data-v-5e0b7199><img width="70"${ssrRenderAttr("src", _imports_0$2)} alt="" data-v-5e0b7199><span class="underline" data-v-5e0b7199>${ssrInterpolate(_ctx.$t("AboutUs"))}</span></h1></div><div class="${ssrRenderClass([_ctx.$i18n.locale === "ar" ? "ar" : "", "desc"])}" data-v-5e0b7199>${ssrInterpolate((_a = unref(About)[0]) == null ? void 0 : _a.description)}</div><div class="mt-7 d-flex justify-content-end" data-v-5e0b7199>`);
        _push(ssrRenderComponent(_component_nuxt_link, {
          to: "/About",
          class: "btn"
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span data-v-5e0b7199${_scopeId}>${ssrInterpolate(_ctx.$t("ReadMore"))}</span>`);
            } else {
              return [
        ...
        _push(`</div></div><div class="about-img col-lg-6"${ssrRenderAttr("data-aos", _ctx.$i18n.locale === "ar" ? "fade-right" : "fade-left")} data-aos-duration="800" data-v-5e0b7199><img${ssrRenderAttr("src", `${unref(apiBase)}/${(_b = unref(About)[0]) == null ? void 0 : _b.photo}`)} alt="" data-v-5e0b7199></div></div></div>`);
      }
      _push(`</div>`);
    };
  }
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-5e0b7199"]]);
const _sfc_main$3 = {
  __name: "Album",
  __ssrInlineRender: true,
  async setup(__props) {
...
const _sfc_main$2 = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "reviews" }, _attrs))} data-v-2b0691b7><div class="container" data-v-2b0691b7><h1 data-v-2b0691b7><img width="70"${ssrRenderAttr("src", _imports_0$2)} alt="" data-v-2b0691b7><span data-v-2b0691b7>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0644\u062A\u0639\u0644\u064A\u0642\u0627\u062A" : "Reviews")}</span></h1>`);
      if (_ctx.pending) {
        _push(`<div class="text-center text-white loader" data-v-2b0691b7>`);
        _push(ssrRenderComponent(_component_ElementsSpinner, null, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<div data-v-2b0691b7>`);
        _push(ssrRenderComponent(_component_Swiper, {
          style: { "direction": "ltr" },
          modules: ["SwiperAutoplay" in _ctx ? _ctx.SwiperAutoplay : unref(Autoplay), "SwiperPagination" in _ctx ? _ctx.SwiperPagination : unref(Pagination)],
          loop: false,
            ...
            if (_push2) {
              ...
              ssrRenderList(unref(Reviews), (review) => {
                _push2(ssrRenderComponent(_component_SwiperSlide, null, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<div class="review" data-v-2b0691b7${_scopeId2}><div class="leaf" data-v-2b0691b7${_scopeId2}><img${ssrRenderAttr("src", _imports_1)} alt="" data-v-2b0691b7${_scopeId2}></div><div class="title" data-v-2b0691b7${_scopeId2}><img width="40"${ssrRenderAttr("src", _imports_2)} alt="" data-v-2b0691b7${_scopeId2}><h2 class="mx-3" data-v-2b0691b7${_scopeId2}>${ssrInterpolate(review.customer_name)}</h2></div><div class="desc" data-v-2b0691b7${_scopeId2}>${ssrInterpolate(review.message)}</div><div class="rate" data-v-2b0691b7${_scopeId2}>`);
...
const __nuxt_component_6 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-2b0691b7"]]);
const _sfc_main$1 = {};
...
//# sourceMappingURL=index-PKRZfe1p.mjs.map
