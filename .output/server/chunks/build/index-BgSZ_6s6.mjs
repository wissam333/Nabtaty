...
const _sfc_main$4 = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ElementsSpinner = __nuxt_component_0$2;
      const _component_nuxt_link = __nuxt_component_2$1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "about" }, _attrs))} data-v-b84afc87>`);
      if (unref(pending)) {
        _push(`<div class="text-center text-white" data-v-b84afc87>`);
        _push(ssrRenderComponent(_component_ElementsSpinner, null, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<div class="container" data-v-b84afc87><div class="about-content row" data-v-b84afc87><div class="about-info col-lg-6"${ssrRenderAttr("data-aos", _ctx.$i18n.locale === "ar" ? "fade-left" : "fade-right")} data-aos-duration="800" data-v-b84afc87><div class="title" data-v-b84afc87><h1 class="d-flex align-items-center" data-v-b84afc87><img width="70"${ssrRenderAttr("src", _imports_0$2)} alt="" data-v-b84afc87><span class="underline" data-v-b84afc87>${ssrInterpolate(_ctx.$t("AboutUs"))}</span></h1></div><div class="${ssrRenderClass([_ctx.$i18n.locale === "ar" ? "ar" : "", "desc"])}" data-v-b84afc87>${ssrInterpolate((_a = unref(About)[0]) == null ? void 0 : _a.description)}</div><div class="mt-7 d-flex justify-content-end" data-v-b84afc87>`);
        _push(ssrRenderComponent(_component_nuxt_link, {
          to: "/About",
          class: "btn"
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span data-v-b84afc87${_scopeId}>${ssrInterpolate(_ctx.$t("ReadMore"))}</span>`);
            } else {
              return [
        ...
        _push(`</div></div><div class="about-img col-lg-6"${ssrRenderAttr("data-aos", _ctx.$i18n.locale === "ar" ? "fade-right" : "fade-left")} data-aos-duration="800" data-v-b84afc87><img${ssrRenderAttr("src", `${unref(apiBase)}/${(_b = unref(About)[0]) == null ? void 0 : _b.photo}`)} alt="" data-v-b84afc87></div></div></div>`);
      }
      _push(`</div>`);
    };
  }
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-b84afc87"]]);
const _sfc_main$3 = {
  __name: "Album",
  __ssrInlineRender: true,
  async setup(__props) {
...
//# sourceMappingURL=index-BgSZ_6s6.mjs.map
