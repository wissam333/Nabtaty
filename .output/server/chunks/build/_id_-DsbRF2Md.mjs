...
import __nuxt_component_2$1 from './Icon-IZ0bJGMm.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-0648b9ef>`);
      if (unref(pending)) {
        _push(`<div class="loading" data-v-0648b9ef>`);
        _push(ssrRenderComponent(_component_ElementsSpinner, null, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<div class="container" style="${ssrRenderStyle({ "position": "relative" })}" data-v-0648b9ef><h5 class="links mb-10" data-v-0648b9ef><span class="pointer" data-v-0648b9ef>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0645\u0646\u062A\u062C\u0627\u062A\u0646\u0627" : "Products")}</span> / ${ssrInterpolate(_ctx.$i18n.locale === "ar" ? (_a2 = unref(Product)[0]) == null ? void 0 : _a2.plant_name : (_b = unref(Product)[0]) == null ? void 0 : _b.plant_name)}</h5><div class="row reverse-mobile" data-v-0648b9ef><div class="info col-lg-6" data-v-0648b9ef><div class="heart" data-v-0648b9ef>`);
        if ((_c = ("useUserInfo" in _ctx ? _ctx.useUserInfo : unref(useUserInfo))().value) == null ? void 0 : _c.email) {
          _push(`<span data-v-0648b9ef>`);
          if (!unref(isFavorite)) {
        ...
        _push(`</div><h2 class="title" data-v-0648b9ef><img class="leaf"${ssrRenderAttr("src", _imports_0)} alt="" data-v-0648b9ef> ${ssrInterpolate(_ctx.$i18n.locale === "ar" ? (_d = unref(Product)[0]) == null ? void 0 : _d.plant_name : (_e = unref(Product)[0]) == null ? void 0 : _e.plant_name)}</h2><h2 class="price" data-v-0648b9ef><span data-v-0648b9ef>${ssrInterpolate(unref(activeSize)[0].Price)} ${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u062F\u064A\u0646\u0627\u0631" : "JOD")}</span></h2><div data-v-0648b9ef></div>`);
        if ((_f = unref(Product)[0]) == null ? void 0 : _f.description) {
          _push(`<div class="desc mt-5" data-v-0648b9ef><div data-v-0648b9ef>${_ctx.$i18n.locale === "ar" ? (_g = unref(Product)[0]) == null ? void 0 : _g.description : (_h = unref(Product)[0]) == null ? void 0 : _h.description}</div></div>`);
        } else {
          _push(`<!---->`);
        }
        if (!((_i = unref(Product)[0]) == null ? void 0 : _i.description)) {
          _push(`<div class="mt-5" data-v-0648b9ef><h5 class="fw-bold" data-v-0648b9ef>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0644\u0627 \u064A\u0648\u062C\u062F \u0648\u0635\u0641" : "There is no description")}</h5></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="" data-v-0648b9ef><h5 class="mt-5" data-v-0648b9ef>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0627\u062D\u062C\u0627\u0645" : "Sizes")}</h5><div class="circles" data-v-0648b9ef><!--[-->`);
        ssrRenderList(unref(Sizes), (size) => {
          _push(`<div class="${ssrRenderClass([unref(activeSize).includes(size) ? "active" : "", "circle sizes"])}" style="${ssrRenderStyle(size.Price > 0 ? null : { display: "none" })}"${ssrRenderAttr("title", tooltipString(size.name))} data-v-0648b9ef><span data-v-0648b9ef>${ssrInterpolate(size.name)}</span></div>`);
        });
        _push(`<!--]--></div></div><div class="d-flex align-items-center" data-v-0648b9ef><div class="quantity" data-v-0648b9ef><div class="flex-auto" data-v-0648b9ef><label for="minmax-buttons" class="font-bold block mb-2" data-v-0648b9ef><h5 class="mb-0" data-v-0648b9ef>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0643\u0645\u064A\u0629" : "Quantity")}</h5></label>`);
        ...
        _push(`</div></div><div class="add-to-cart mt-14 mx-3" data-v-0648b9ef><button class="btn" data-v-0648b9ef><span data-v-0648b9ef>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0623\u0636\u0641 \u0644\u0644\u0633\u0644\u0629" : "Add To Cart")}</span></button></div></div><div class="my-4" data-v-0648b9ef>`);
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_v_tab, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="d-flex flex-column" data-v-0648b9ef${_scopeId2}>`);
        ...
        _push(`<div class="mt-4" style="${ssrRenderStyle({ "color": "#333 !important", "opacity": "1" })}" data-v-0648b9ef>`);
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_v_window_item, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<h5 style="${ssrRenderStyle({ "color": "#78c044", "font-weight": "bold" })}" data-v-0648b9ef${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_font_awesome, { icon: ["fas", "droplet"] }, null, _parent3, _scopeId2));
                    _push3(` ${ssrInterpolate(_ctx.$i18n.locale == "en" ? "Water" : "\u0645\u0627\u0621")}</h5><p data-v-0648b9ef${_scopeId2}>${ssrInterpolate(unref(Product)[0].water)}</p>`);
                  } else {
                    return [
              ...
              _push2(ssrRenderComponent(_component_v_window_item, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<h5 style="${ssrRenderStyle({ "color": "#78c044", "font-weight": "bold" })}" data-v-0648b9ef${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_font_awesome, { icon: ["fas", "cloud-sun"] }, null, _parent3, _scopeId2));
                    _push3(` ${ssrInterpolate(_ctx.$i18n.locale == "en" ? "Part Sun" : "\u0645\u0634\u0645\u0633 \u0628\u0634\u0643\u0644 \u062C\u0632\u0626\u064A")}</h5><p data-v-0648b9ef${_scopeId2}>${ssrInterpolate(unref(Product)[0].part_sun)}</p>`);
                  } else {
                    return [
                      createVNode("h5", { style: { "color": "#78c044", "font-weight": "bold" } }, [
                        createVNode(_component_font_awesome, { icon: ["fas", "cloud-sun"] }),
              ...
              _push2(ssrRenderComponent(_component_v_window_item, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<h5 style="${ssrRenderStyle({ "color": "#78c044", "font-weight": "bold" })}" data-v-0648b9ef${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_font_awesome, { icon: ["fas", "hands-holding"] }, null, _parent3, _scopeId2));
                    _push3(` ${ssrInterpolate(_ctx.$i18n.locale == "en" ? "Ease of care" : "\u0633\u0647\u0648\u0644\u0629 \u0627\u0644\u0639\u0646\u0627\u064A\u0629")}</h5><p data-v-0648b9ef${_scopeId2}>${ssrInterpolate(unref(Product)[0].medium)}</p>`);
                  } else {
                    return [
                      createVNode("h5", { style: { "color": "#78c044", "font-weight": "bold" } }, [
                        createVNode(_component_font_awesome, { icon: ["fas", "hands-holding"] }),
              ...
              _push2(ssrRenderComponent(_component_v_window_item, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<h5 style="${ssrRenderStyle({ "color": "#78c044", "font-weight": "bold" })}" data-v-0648b9ef${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_font_awesome, { icon: ["fas", "sun"] }, null, _parent3, _scopeId2));
                    _push3(` ${ssrInterpolate(_ctx.$i18n.locale == "en" ? "Direct sunlight" : "\u0636\u0648\u0621 \u0627\u0644\u0634\u0645\u0633 \u0627\u0644\u0645\u0628\u0627\u0634\u0631")}</h5><p data-v-0648b9ef${_scopeId2}>${ssrInterpolate(unref(Product)[0].light)}</p>`);
                  } else {
                    return [
                      createVNode("h5", { style: { "color": "#78c044", "font-weight": "bold" } }, [
                        createVNode(_component_font_awesome, { icon: ["fas", "sun"] }),
              ...
              _push2(ssrRenderComponent(_component_v_window_item, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<h5 style="${ssrRenderStyle({ "color": "#78c044", "font-weight": "bold" })}" data-v-0648b9ef${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_font_awesome, { icon: ["fas", "temperature-high"] }, null, _parent3, _scopeId2));
                    _push3(` ${ssrInterpolate(_ctx.$i18n.locale == "en" ? "Temperature" : "\u0627\u0644\u062D\u0631\u0627\u0631\u0629")}</h5><p data-v-0648b9ef${_scopeId2}>${ssrInterpolate(unref(Product)[0].temperatures)}</p>`);
                  } else {
                    return [
                      createVNode("h5", { style: { "color": "#78c044", "font-weight": "bold" } }, [
                        createVNode(_component_font_awesome, { icon: ["fas", "temperature-high"] }),
              ...
              _push2(ssrRenderComponent(_component_v_window_item, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<h5 style="${ssrRenderStyle({ "color": "#78c044", "font-weight": "bold" })}" data-v-0648b9ef${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_font_awesome, { icon: ["fas", "square"] }, null, _parent3, _scopeId2));
                    _push3(` ${ssrInterpolate(_ctx.$i18n.locale == "en" ? "Pot" : "\u0627\u0635\u064A\u0635")}</h5><p data-v-0648b9ef${_scopeId2}>${ssrInterpolate(unref(Product)[0].pot)}</p>`);
                  } else {
                    return [
                      createVNode("h5", { style: { "color": "#78c044", "font-weight": "bold" } }, [
                        createVNode(_component_font_awesome, { icon: ["fas", "square"] }),
        ...
        _push(`</div></div></div><div class="col-12 col-lg-6 mb-10" data-v-0648b9ef>`);
        if (unref(Product)) {
      ...
      if ((_l = unref(related)) == null ? void 0 : _l.length) {
        _push(`<div class="container my-10 py-10" data-v-0648b9ef><h1 class="color fw-bold" data-v-0648b9ef>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0643\u062A\u0634\u0641 \u0627\u0644\u0645\u0646\u062A\u062C\u0627\u062A \u0627\u0644\u0645\u0634\u0627\u0628\u0647\u0629" : "Discover similar products")}</h1><div data-v-0648b9ef>`);
        _push(ssrRenderComponent(_component_Swiper, {
          style: { "direction": "ltr" },
            ...
            if (_push2) {
              ...
              ssrRenderList(unref(related), (product) => {
                _push2(ssrRenderComponent(_component_SwiperSlide, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<div class="product"${ssrRenderAttr("dir", _ctx.$i18n.locale === "ar" ? "rtl" : "ltr")} data-v-0648b9ef${_scopeId2}>`);
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0648b9ef"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-DsbRF2Md.mjs.map
