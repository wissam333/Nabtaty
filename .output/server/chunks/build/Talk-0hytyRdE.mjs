...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const DeleteCat = async () => {
      await useFetch(
        `${api.DeleteTalk}/${deleteRegion.value.id}`,
        {
          credentials: "include",
          baseURL: apiBase,
          method: "DELETE"
    ...
    const addInfo = async () => {
      ...
      const { data } = await useFetch(api.AddTalk, {
        baseURL: apiBase,
        credentials: "include",
        method: "POST",
        body: formData
      ...
      src.value = null;
      srcFile.value = null;
      if (!((_a = data.value) == null ? void 0 : _a.plantTalkId)) {
    ...
    const editCat = async () => {
      ...
      await useFetch(
        `${api.UpdateTalk}/${editedCat.value.id}`,
        {
          credentials: "include",
          body: formData,
          baseURL: apiBase,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="${ssrRenderClass([("useSidebar" in _ctx ? _ctx.useSidebar : unref(useSidebar))().value ? "shrink" : "", "contain"])}" data-v-426fdb4a><div class="title-container" data-v-426fdb4a><div class="head-title" data-v-426fdb4a><h4 class="header4" data-v-426fdb4a>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0635\u062D\u0627\u0641\u0629 \u0627\u0644\u0646\u0628\u0627\u062A\u064A\u0629" : "Plant Press")}</h4></div><div class="options" data-v-426fdb4a><div class="reload btn btn-success mx-2" data-v-426fdb4a>`);
      _push(ssrRenderComponent(_component_font_awesome, { icon: ["fas", "plus"] }, null, _parent));
      _push(` ${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0625\u0636\u0627\u0641\u0629" : "Add")}</div><div class="reload btn btn-success" data-v-426fdb4a>`);
      _push(ssrRenderComponent(_component_font_awesome, { icon: ["fas", "rotate-right"] }, null, _parent));
      _push(` ${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0625\u0639\u0627\u062F\u0629 \u062A\u062D\u0645\u064A\u0644" : "Reload")}</div></div></div><div class="table-responsive" data-v-426fdb4a>`);
      if (unref(loading)) {
        _push(`<div class="loading" data-v-426fdb4a><img${ssrRenderAttr("src", _imports_0)} alt="" data-v-426fdb4a></div>`);
      } else {
        _push(`<div class="cat-tabel" data-v-426fdb4a><table data-v-426fdb4a><thead data-v-426fdb4a><tr data-v-426fdb4a><th data-v-426fdb4a>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0635\u0648\u0631\u0629" : "Photo")}</th><th data-v-426fdb4a>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0648\u0635\u0641" : "Description")}</th><th data-v-426fdb4a>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u062A\u0639\u062F\u064A\u0644" : "Edit")}</th></tr></thead><tbody data-v-426fdb4a><!--[-->`);
        ssrRenderList(unref(About), (cat) => {
          var _a;
          _push(`<tr class="rows" data-v-426fdb4a><td data-v-426fdb4a><div data-v-426fdb4a><span data-v-426fdb4a><img height="100"${ssrRenderAttr("src", unref(apiBase) + "/" + cat.photo)} alt="" data-v-426fdb4a></span></div></td><td data-v-426fdb4a><div data-v-426fdb4a><span data-v-426fdb4a>${ssrInterpolate(((_a = cat.description) == null ? void 0 : _a.length) > 30 ? cat.description.slice(0, 30) + "..." : cat.description)}</span></div></td><td data-v-426fdb4a><span class="delete" data-v-426fdb4a>`);
          _push(ssrRenderComponent(_component_font_awesome, { icon: ["fas", "trash"] }, null, _parent));
          _push(`</span><span class="edit-link" data-v-426fdb4a><span class="edit" data-v-426fdb4a>`);
      ...
      _push(ssrRenderComponent(_component_Dialog, {
        ...
        container: withCtx(({ closeCallback }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="dialog"${ssrRenderAttr("dir", _ctx.$i18n.locale === "ar" ? "rtl" : "ltr")} data-v-426fdb4a${_scopeId}><h5 class="fw-bold mb-5" data-v-426fdb4a${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0625\u0636\u0627\u0641\u0629 \u0642\u0633\u0645 \u062C\u062F\u064A\u062F" : "Add New Part")}</h5><div class="content" data-v-426fdb4a${_scopeId}><div data-v-426fdb4a${_scopeId}><div class="d-flex flex-column-reverse mb-3" data-v-426fdb4a${_scopeId}><textarea id="description_AR" type="text" autocomplete="off"${ssrRenderAttr(
              "placeholder",
              _ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0648\u0635\u0641 \u0628\u0627\u0644\u0639\u0631\u0628\u064A" : "Description In Arabic"
            )} required data-v-426fdb4a${_scopeId}>${ssrInterpolate(unref(description_AR))}</textarea><label for="description_AR" data-v-426fdb4a${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0648\u0635\u0641 \u0628\u0627\u0644\u0639\u0631\u0628\u064A" : "Description In Arabic")}</label></div><div class="d-flex flex-column-reverse mb-3" data-v-426fdb4a${_scopeId}><textarea id="description_En" type="text" autocomplete="off"${ssrRenderAttr(
              "placeholder",
              _ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0648\u0635\u0641 \u0628\u0627\u0644\u0627\u0646\u062C\u0644\u064A\u0632\u064A" : "Description In English"
            )} required data-v-426fdb4a${_scopeId}>${ssrInterpolate(unref(description_EN))}</textarea><label for="description_En" data-v-426fdb4a${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0648\u0635\u0641 \u0628\u0627\u0644\u0627\u0646\u062C\u0644\u064A\u0632\u064A" : "Description In English")}</label></div><div class="drop-area my-4" data-v-426fdb4a${_scopeId}><div class="upload-box" data-v-426fdb4a${_scopeId}>`);
            ...
            if (unref(src)) {
              _push2(`<img${ssrRenderAttr("src", unref(src))} alt="Image" class="shadow-md w-100 h-100 sm:w-64" data-v-426fdb4a${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            if (unref(src)) {
              _push2(`<button class="btn btn-danger clear" data-v-426fdb4a${_scopeId}>`);
            ...
            _push2(`</div></div></div></div><div class="mt-5 d-flex w-100 justify-content-end" data-v-426fdb4a${_scopeId}><button class="btn btn-secondary" data-v-426fdb4a${_scopeId}>${ssrInterpolate(_ctx.$t("Close"))}</button><button class="btn btn-success mx-2" autofocus data-v-426fdb4a${_scopeId}>${ssrInterpolate(_ctx.$t("Add"))}</button></div></div>`);
          } else {
            return [
              createVNode("div", {
                class: "dialog",
      ...
      _push(ssrRenderComponent(_component_Dialog, {
        ...
        container: withCtx(({ closeCallback }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="dialog"${ssrRenderAttr("dir", _ctx.$i18n.locale === "ar" ? "rtl" : "ltr")} data-v-426fdb4a${_scopeId}><span data-v-426fdb4a${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u062A\u0639\u062F\u064A\u0644 \u0627\u0644\u0645\u0639\u0644\u0648\u0645\u0627\u062A " : "Edit Information")}</span><div class="content" data-v-426fdb4a${_scopeId}><div data-v-426fdb4a${_scopeId}><div class="d-flex flex-column-reverse mb-3" data-v-426fdb4a${_scopeId}><textarea id="editDescription_AR" type="text" autocomplete="off" rows="5"${ssrRenderAttr(
              "placeholder",
              _ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0648\u0635\u0641 \u0628\u0627\u0644\u0639\u0631\u0628\u064A" : "Description In Arabic"
            )} required data-v-426fdb4a${_scopeId}>${ssrInterpolate(unref(editDescription_AR))}</textarea><label for="editDescription_AR" data-v-426fdb4a${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0648\u0635\u0641 \u0628\u0627\u0644\u0639\u0631\u0628\u064A" : "Description In Arabic")}</label></div><div class="d-flex flex-column-reverse mb-3" data-v-426fdb4a${_scopeId}><textarea id="editDescription_EN" type="text" autocomplete="off"${ssrRenderAttr(
              "placeholder",
              _ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0648\u0635\u0641 \u0628\u0627\u0644\u0627\u0646\u062C\u0644\u064A\u0632\u064A" : "Description In English"
            )} rows="5" required data-v-426fdb4a${_scopeId}>${ssrInterpolate(unref(editDescription_EN))}</textarea><label for="editDescription_EN" data-v-426fdb4a${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0648\u0635\u0641 \u0628\u0627\u0644\u0627\u0646\u062C\u0644\u064A\u0632\u064A" : "Description In English")}</label></div><div class="drop-area my-4" data-v-426fdb4a${_scopeId}><div class="upload-box" data-v-426fdb4a${_scopeId}>`);
            _push2(ssrRenderComponent(_component_FileUpload, {
              mode: "basic",
            ...
            if (unref(editsrc)) {
              _push2(`<img${ssrRenderAttr("src", unref(editsrc))} alt="Image" class="shadow-md w-100 h-100 sm:w-64" data-v-426fdb4a${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div></div><div class="mt-5 d-flex w-100 justify-content-end" data-v-426fdb4a${_scopeId}><button class="btn btn-secondary" data-v-426fdb4a${_scopeId}>${ssrInterpolate(_ctx.$t("Close"))}</button><button class="btn btn-success mx-2" autofocus data-v-426fdb4a${_scopeId}>${ssrInterpolate(_ctx.$t("Edit"))}</button></div></div>`);
          } else {
            return [
              createVNode("div", {
                class: "dialog",
      ...
      _push(ssrRenderComponent(_component_ElementsAppModal, {
        ...
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h4 data-v-426fdb4a${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u062A\u0623\u0643\u064A\u062F \u0627\u0644\u062D\u0630\u0641" : "Confirm Delete")}</h4>`);
          } else {
            return [
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p data-v-426fdb4a${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0647\u0644 \u0623\u0646\u062A \u0645\u062A\u0623\u0643\u062F \u0645\u0646 \u0623\u0646\u0643 \u062A\u0631\u064A\u062F \u062D\u0630\u0641" : "Are You Sure You Want To Delete")} ${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u061F" : "?")}</p>`);
          } else {
            return [
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button class="btn btn-secondary" data-v-426fdb4a${_scopeId}>${ssrInterpolate(_ctx.$t("Close"))}</button><button class="btn btn-danger" data-v-426fdb4a${_scopeId}>${ssrInterpolate(_ctx.$t("Delete"))}</button>`);
          } else {
            return [
              createVNode("button", {
                class: "btn btn-secondary",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/Talk.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const Talk = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-426fdb4a"]]);

export { Talk as default };
//# sourceMappingURL=Talk-0hytyRdE.mjs.map
