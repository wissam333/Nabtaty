...
const _sfc_main$b = {
  ...
  async setup(__props) {
    ...
    ref(false);
    [__temp, __restore] = withAsyncContext(() => useFetch(`https://server.nabtaty.com/api/findMyInfo`, "$vML4fiuVup")), __temp = await __temp, __restore();
    watchEffect(() => {
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "home" }, _attrs))} data-v-a7a89e55><div class="slider" data-v-a7a89e55>`);
      if (unref(pending)) {
        _push(`<div class="text-center text-white loader" data-v-a7a89e55>`);
        _push(ssrRenderComponent(_component_ElementsSpinner, null, null, _parent));
        _push(`</div>`);
      } else if (!unref(pending)) {
        _push(`<div data-v-a7a89e55>`);
              ...
              ssrRenderList(unref(MainImg), (image) => {
                _push2(ssrRenderComponent(_component_SwiperSlide, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<div class="main-img" data-v-a7a89e55${_scopeId2}><img class="main"${ssrRenderAttr("src", `${unref(apiBase)}/${image.photo}`)} data-v-a7a89e55${_scopeId2}></div>`);
                    } else {
                      return [
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-a7a89e55"]]);
...
//# sourceMappingURL=index-BtTITxUW.mjs.map
