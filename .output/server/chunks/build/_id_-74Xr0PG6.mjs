...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "Products" }, _attrs))} data-v-f57c6d47><div class="" data-v-f57c6d47><div class="row" data-v-f57c6d47><div class="${ssrRenderClass([_ctx.$i18n.locale === "ar" ? "ar" : "", "col-lg-2"])}" data-v-f57c6d47><div class="wrapper" data-v-f57c6d47><h2 data-v-f57c6d47><span data-v-f57c6d47>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0641\u0626\u0627\u062A" : "Categories")} `);
      _push(ssrRenderComponent(_component_font_awesome, {
        style: { "transform": "rotate(90deg)" },
        icon: ["fas", "sliders"]
      }, null, _parent));
      _push(`</span></h2><div class="allfilter mt-8" data-v-f57c6d47>`);
      _push(ssrRenderComponent(_component_PanelMenu, {
        ...
        item: withCtx(({ item: item2, hasSubmenu }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="filterbox pointer d-flex justify-content-between" data-v-f57c6d47${_scopeId}><span class="${ssrRenderClass([unref(selectedId) == item2.id ? "active" : "", "cat"])}" data-v-f57c6d47${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale == "en" ? item2.category_name : item2.category_name)}</span>`);
            if (hasSubmenu) {
              _push2(`<span class="drop-down" data-v-f57c6d47${_scopeId}><span data-v-f57c6d47${_scopeId}>&gt;</span></span>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
      ...
      if (unref(loading2) || _ctx.pending) {
        _push(`<div class="col-lg-10 loader" data-v-f57c6d47>`);
        _push(ssrRenderComponent(_component_ElementsSpinner, null, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<div class="col-lg-10" data-v-f57c6d47><div class="links" data-v-f57c6d47>`);
        ...
        if ((_a = _ctx.Categories) == null ? void 0 : _a.parentCategoryId) {
          _push(`<span data-v-f57c6d47> / ${ssrInterpolate(getMainCat(_ctx.Categories.parentCategoryId))}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(` / <span data-v-f57c6d47>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? (_b = _ctx.Categories) == null ? void 0 : _b.category_name : (_c = _ctx.Categories) == null ? void 0 : _c.category_name)}</span></div><div class="title" data-v-f57c6d47><h1 class="d-flex align-items-center" data-v-f57c6d47><span class="underline" data-v-f57c6d47>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? (_d = _ctx.Categories) == null ? void 0 : _d.category_name : (_e = _ctx.Categories) == null ? void 0 : _e.category_name)}</span></h1></div><div class="d-flex justify-content-start align-items-end mb-10" data-v-f57c6d47><div class="d-flex mt-5 justify-content-start align-items-center top" style="${ssrRenderStyle({ "flex-wrap": "wrap", "gap": "10px" })}" data-v-f57c6d47><div class="select" data-v-f57c6d47>`);
        ...
        _push(`</div></div></div><div class="grid3" data-v-f57c6d47><!--[-->`);
        ssrRenderList(unref(filteredProducts), (product) => {
          _push(`<div class="product" data-aos="fade-up" data-v-f57c6d47><div data-v-f57c6d47>`);
        ...
        _push(`<!--]--></div><h1 style="${ssrRenderStyle([
          ...
          { "color": "#333" }
        ])}" class="text-center my-10 py-10" data-v-f57c6d47>${ssrInterpolate(_ctx.$i18n.locale == "ar" ? "\u0646\u0639\u062A\u0630\u0631 \u0644\u0627 \u064A\u0648\u062C\u062F \u0645\u0646\u062A\u062C\u0627\u062A" : "Sorry No Items")}</h1></div>`);
      }
      _push(`</div></div></div>`);
    };
  }
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f57c6d47"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-74Xr0PG6.mjs.map
