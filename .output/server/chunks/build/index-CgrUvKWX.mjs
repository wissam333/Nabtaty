...
const _sfc_main$b = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "home" }, _attrs))} data-v-e11b2974><div class="slider" data-v-e11b2974>`);
      if (unref(pending)) {
        _push(`<div class="text-center text-white loader" data-v-e11b2974>`);
        _push(ssrRenderComponent(_component_ElementsSpinner, null, null, _parent));
        _push(`</div>`);
      } else if (!unref(pending)) {
        _push(`<div data-v-e11b2974>`);
              ...
              ssrRenderList(unref(MainImg), (image) => {
                _push2(ssrRenderComponent(_component_SwiperSlide, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<div class="main-img" data-v-e11b2974${_scopeId2}><img class="main"${ssrRenderAttr("src", `${unref(apiBase)}/${image.photo}`)} data-v-e11b2974${_scopeId2}></div>`);
                    } else {
                      return [
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-e11b2974"]]);
...
//# sourceMappingURL=index-CgrUvKWX.mjs.map
