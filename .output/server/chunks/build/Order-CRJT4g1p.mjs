...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "order nav-margin" }, _attrs))} data-v-44a1aed8><div class="container" data-v-44a1aed8><div class="title" data-v-44a1aed8><h1 class="d-flex align-items-center justify-content-center" data-v-44a1aed8><img width="70"${ssrRenderAttr("src", _imports_0)} alt="" data-v-44a1aed8><span class="underline" data-v-44a1aed8>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0639\u0645\u0644\u064A\u0629 \u0627\u0644\u0637\u0644\u0628" : "Checkout")}</span></h1></div><div class="row" data-v-44a1aed8><div class="col-md-12" data-v-44a1aed8><h4 class="my-3 text-center text-white text-sm-start" data-v-44a1aed8>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0645\u0639\u0644\u0648\u0645\u0627\u062A \u0627\u0644\u0645\u0646\u062A\u062C" : "Product Information")}</h4>`);
      ...
      _push(ssrRenderComponent(_component_VForm, {
        ...
        default: withCtx(({ meta: formMeta, values }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div data-v-44a1aed8${_scopeId}>`);
            if (unref(hasError)) {
              _push2(`<div class="error-messages mb-3" data-v-44a1aed8${_scopeId}><div class="alert alert-danger text-center" data-v-44a1aed8${_scopeId}><ul class="list-unstyled mb-0" data-v-44a1aed8${_scopeId}><!--[-->`);
              ssrRenderList(unref(errorMessage), (error, index) => {
                _push2(`<li data-v-44a1aed8${_scopeId}>${ssrInterpolate(error)}</li>`);
              });
              _push2(`<!--]--></ul></div></div>`);
            } else {
              _push2(`<!---->`);
            ...
            _push2(`<div style="${ssrRenderStyle({ "height": "50vh", "width": "100%", "margin": "auto", "z-index": "10" })}" data-v-44a1aed8${_scopeId}>`);
            _push2(ssrRenderComponent(_component_ClientOnly, null, {}, _parent2, _scopeId));
            _push2(`</div><div class="col-md-12 form-group mt-4 d-flex justify-content-center justify-content-sm-start" data-v-44a1aed8${_scopeId}><button type="submit" value="Login" class="${ssrRenderClass([{ background: formMeta.valid }, "background btn px-10 py-2 text-black w-50 btn-block m-auto"])}" data-v-44a1aed8${_scopeId}>`);
            if (!unref(isLoading)) {
              _push2(`<span class="text-white" data-v-44a1aed8${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0623\u0637\u0644\u0628 \u0627\u0644\u0622\u0646" : "Order Now")}</span>`);
            } else {
              _push2(`<span class="text-black" data-v-44a1aed8${_scopeId}>${ssrInterpolate(_ctx.$t("loading..."))}</span>`);
            }
            _push2(`</button></div>`);
          } else {
            return [
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-44a1aed8"]]);
const _sfc_main = {
  __name: "Order",
  __ssrInlineRender: true,
  async setup(__props) {
...
//# sourceMappingURL=Order-CRJT4g1p.mjs.map
