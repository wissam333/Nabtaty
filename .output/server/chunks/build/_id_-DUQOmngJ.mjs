import { _ as __nuxt_component_1, s as script$8, a as script$1$2, U as UniqueComponentId } from './index-BFcmdMGK.mjs';
import { _ as _sfc_main$2 } from './icon-jIl0hTBH.mjs';
import { Swiper, SwiperSlide } from 'swiper/vue';
import __nuxt_component_2$1 from './Icon-B1y53nWh.mjs';
import { B as BaseStyle, _ as _export_sfc, k as useI18n, o as useRoute$1, a as useRouter$1, i as useGetSiteApi, u as useRuntimeConfig, g as useNuxtApp } from './server.mjs';
import { useSSRContext, withAsyncContext, ref, watchEffect, resolveComponent, mergeProps, unref, isRef, withCtx, createVNode, createTextVNode, toDisplayString, onUnmounted, openBlock, createBlock, Fragment, renderList, createElementBlock, normalizeClass, normalizeStyle, renderSlot, createElementVNode, toHandlers, resolveDynamicComponent, createCommentVNode, resolveDirective, withDirectives, Transition } from 'vue';
...
import { B as BaseDirective, s as script$9, a as script$3$2, R as Ripple, b as script$2$2, c as script$4$1, d as script$5$1 } from './index-J5dMXp_o.mjs';
...
import { a as useAuth, b as useUserInfo, f as useMainToken } from './useState-D7RI69Dw.mjs';
import { _ as _imports_1 } from './virtual_public-DdiQcbvu.mjs';
import '@primeuix/styled';
import '@primeuix/utils/uuid';
import '@fortawesome/fontawesome-svg-core';
import './index-nePnNpl_.mjs';
import '../runtime.mjs';
import 'node:http';
import 'node:https';
import 'fs';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div style="${ssrRenderStyle({ "position": "relative" })}" class="${ssrRenderClass([_ctx.$i18n.locale === "en" ? "en" : "", "preview-section d-flex"])}" data-v-079b8014>`);
      if (__props.disscount) {
        _push(`<div class="disscount" data-v-079b8014>${ssrInterpolate(__props.disscount + "%")}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="nav-imgs"${ssrRenderAttr("dir", _ctx.$i18n.locale === "en" ? "rtl" : "ltr")} data-v-079b8014><div class="nav-frame d-flex" data-v-079b8014>`);
            ...
            ssrRenderList(unref(allImgs), (imgItem, index) => {
              _push2(ssrRenderComponent(_component_SwiperSlide, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<img${ssrRenderAttr("src", `${unref(apiBase)}/${imgItem}`)} alt="nav-img" data-v-079b8014${_scopeId2}>`);
                  } else {
                    return [
                      createVNode("img", {
                        src: `${unref(apiBase)}/${imgItem}`,
                        alt: "nav-img",
      ...
      _push(`</div></div><div class="view-img" data-v-079b8014>`);
      _push(ssrRenderComponent(_component_v_carousel, {
        ...
        prev: withCtx(({ props }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flip-icon pcc" data-v-079b8014${_scopeId}>`);
      ...
      _push(ssrRenderComponent(_component_Galleria, {
        ...
        item: withCtx((slotProps, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", `${unref(apiBase)}/${slotProps.item}`)}${ssrRenderAttr("alt", slotProps.item)} class="mainImg" data-v-079b8014${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: `${unref(apiBase)}/${slotProps.item}`,
                alt: slotProps.item,
                class: "mainImg"
              }, null, 8, ["src", "alt"])
            ];
        ...
        thumbnail: withCtx((slotProps, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div style="${ssrRenderStyle({ "padding": "20px", "width": "150px", "height": "150px" })}" data-v-079b8014${_scopeId}><img${ssrRenderAttr("src", `${unref(apiBase)}/${slotProps.item}`)}${ssrRenderAttr("alt", slotProps.item)} style="${ssrRenderStyle({ "display": "block", "object-fit": "contain", "width": "100%", "height": "100%", "border-radius": "8px", "border": "2px solid #bf9847" })}" data-v-079b8014${_scopeId}></div>`);
          } else {
            return [
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-079b8014"]]);
var script$3 = {
  name: "AngleDownIcon",
  "extends": script$8
};
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    useRouter$1();
    const { data: Product, pending } = ([__temp, __restore] = withAsyncContext(() => useGetSiteApi().GetAll(
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ElementsSpinner = __nuxt_component_1;
      ...
      }, _attrs))} data-v-1b87d9d1>`);
      if (unref(pending)) {
        _push(`<div class="loading" data-v-1b87d9d1>`);
        _push(ssrRenderComponent(_component_ElementsSpinner, null, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<div class="container" style="${ssrRenderStyle({ "position": "relative" })}" data-v-1b87d9d1><h5 class="links mb-10" data-v-1b87d9d1><span class="pointer" data-v-1b87d9d1>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0645\u0646\u062A\u062C\u0627\u062A\u0646\u0627" : "Products")}</span> / ${ssrInterpolate(_ctx.$i18n.locale === "ar" ? (_a = unref(Product)[0]) == null ? void 0 : _a.plant_name : (_b = unref(Product)[0]) == null ? void 0 : _b.plant_name)}</h5><div class="row" data-v-1b87d9d1><div class="info col-lg-6" data-v-1b87d9d1><div class="heart" data-v-1b87d9d1>`);
        if (unref(isAuth).isAuthenticated) {
          _push(`<span data-v-1b87d9d1>`);
        ...
        _push(`</div><h2 class="title" data-v-1b87d9d1><img class="leaf"${ssrRenderAttr("src", _imports_1)} alt="" data-v-1b87d9d1> ${ssrInterpolate(_ctx.$i18n.locale === "ar" ? (_d = unref(Product)[0]) == null ? void 0 : _d.plant_name : (_e = unref(Product)[0]) == null ? void 0 : _e.plant_name)}</h2><h2 class="price" data-v-1b87d9d1><span class="${ssrRenderClass(((_g = (_f = unref(Product)) == null ? void 0 : _f.productOffer) == null ? void 0 : _g.newPrice) ? "line-through" : "")}" data-v-1b87d9d1>${ssrInterpolate((_a2 = (_h = unref(Product)[0]) == null ? void 0 : _h.price) != null ? _a2 : "999")} ${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u062F\u0631\u0647\u0645 \u0625\u0645\u0627\u0631\u0627\u062A\u064A" : "AED")}</span>`);
        if ((_j = (_i = unref(Product)) == null ? void 0 : _i.productOffer) == null ? void 0 : _j.newPrice) {
          _push(`<span class="mx-2" data-v-1b87d9d1>${ssrInterpolate((_l = (_k = unref(Product)[0]) == null ? void 0 : _k.productOffer) == null ? void 0 : _l.newPrice)} ${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u062F\u0631\u0647\u0645 \u0625\u0645\u0627\u0631\u0627\u062A\u064A" : "AED")}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</h2><div class="quantity" data-v-1b87d9d1><div class="flex-auto" data-v-1b87d9d1><label for="minmax-buttons" class="font-bold block mb-2" data-v-1b87d9d1><h5 class="mb-0" data-v-1b87d9d1>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0643\u0645\u064A\u0629" : "Quantity")}</h5></label>`);
        ...
        if ((_m = unref(Product)[0]) == null ? void 0 : _m.description) {
          _push(`<div class="desc mt-5" data-v-1b87d9d1><div data-v-1b87d9d1>${_ctx.$i18n.locale === "ar" ? (_n = unref(Product)[0]) == null ? void 0 : _n.description : (_o = unref(Product)[0]) == null ? void 0 : _o.description}</div></div>`);
        } else {
          _push(`<!---->`);
        }
        if (!((_p = unref(Product)) == null ? void 0 : _p.arabicDescription) && !((_q = unref(Product)) == null ? void 0 : _q.weight) && !((_r = unref(Product)) == null ? void 0 : _r.unitName)) {
          _push(`<div class="mt-5" data-v-1b87d9d1><h5 class="fw-bold" data-v-1b87d9d1>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0644\u0627 \u064A\u0648\u062C\u062F \u0648\u0635\u0641" : "There is no description")}</h5></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="add-to-cart mt-4" data-v-1b87d9d1><button class="btn" data-v-1b87d9d1><span data-v-1b87d9d1>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0623\u0636\u0641 \u0644\u0644\u0633\u0644\u0629" : "Add To Cart")}</span></button></div><div class="my-4" data-v-1b87d9d1>`);
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_v_tab, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="d-flex flex-column" data-v-1b87d9d1${_scopeId2}>`);
        ...
        _push(`<div class="mt-4" style="${ssrRenderStyle({ "color": "#333 !important", "opacity": "1" })}" data-v-1b87d9d1>`);
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_v_window_item, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<h5 style="${ssrRenderStyle({ "color": "#78c044", "font-weight": "bold" })}" data-v-1b87d9d1${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_font_awesome, { icon: ["fas", "droplet"] }, null, _parent3, _scopeId2));
                    _push3(` ${ssrInterpolate(_ctx.$i18n.locale == "en" ? "Water" : "\u0645\u0627\u0621")}</h5><p data-v-1b87d9d1${_scopeId2}>${ssrInterpolate(unref(Product)[0].water)}</p>`);
                  } else {
                    return [
              ...
              _push2(ssrRenderComponent(_component_v_window_item, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<h5 style="${ssrRenderStyle({ "color": "#78c044", "font-weight": "bold" })}" data-v-1b87d9d1${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_font_awesome, { icon: ["fas", "cloud-sun"] }, null, _parent3, _scopeId2));
                    _push3(` ${ssrInterpolate(_ctx.$i18n.locale == "en" ? "Part Sun" : "\u0645\u0634\u0645\u0633 \u0628\u0634\u0643\u0644 \u062C\u0632\u0626\u064A")}</h5><p data-v-1b87d9d1${_scopeId2}>${ssrInterpolate(unref(Product)[0].part_sun)}</p>`);
                  } else {
                    return [
                      createVNode("h5", { style: { "color": "#78c044", "font-weight": "bold" } }, [
                        createVNode(_component_font_awesome, { icon: ["fas", "cloud-sun"] }),
              ...
              _push2(ssrRenderComponent(_component_v_window_item, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<h5 style="${ssrRenderStyle({ "color": "#78c044", "font-weight": "bold" })}" data-v-1b87d9d1${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_font_awesome, { icon: ["fas", "snowflake"] }, null, _parent3, _scopeId2));
                    _push3(` ${ssrInterpolate(_ctx.$i18n.locale == "en" ? "Medium" : "\u0648\u0633\u0637")}</h5><p data-v-1b87d9d1${_scopeId2}>${ssrInterpolate(unref(Product)[0].medium)}</p>`);
                  } else {
                    return [
                      createVNode("h5", { style: { "color": "#78c044", "font-weight": "bold" } }, [
                        createVNode(_component_font_awesome, { icon: ["fas", "snowflake"] }),
              ...
              _push2(ssrRenderComponent(_component_v_window_item, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<h5 style="${ssrRenderStyle({ "color": "#78c044", "font-weight": "bold" })}" data-v-1b87d9d1${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_font_awesome, { icon: ["fas", "sun"] }, null, _parent3, _scopeId2));
                    _push3(` ${ssrInterpolate(_ctx.$i18n.locale == "en" ? "Light" : "\u0627\u0644\u0636\u0648\u0621")}</h5><p data-v-1b87d9d1${_scopeId2}>${ssrInterpolate(unref(Product)[0].light)}</p>`);
                  } else {
                    return [
                      createVNode("h5", { style: { "color": "#78c044", "font-weight": "bold" } }, [
                        createVNode(_component_font_awesome, { icon: ["fas", "sun"] }),
              ...
              _push2(ssrRenderComponent(_component_v_window_item, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<h5 style="${ssrRenderStyle({ "color": "#78c044", "font-weight": "bold" })}" data-v-1b87d9d1${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_font_awesome, { icon: ["fas", "temperature-high"] }, null, _parent3, _scopeId2));
                    _push3(` ${ssrInterpolate(_ctx.$i18n.locale == "en" ? "Temperature" : "\u062F\u0631\u062C\u0629 \u062D\u0631\u0627\u0631\u0629")}</h5><p data-v-1b87d9d1${_scopeId2}>${ssrInterpolate(unref(Product)[0].temperatures)}</p>`);
                  } else {
                    return [
                      createVNode("h5", { style: { "color": "#78c044", "font-weight": "bold" } }, [
                        createVNode(_component_font_awesome, { icon: ["fas", "temperature-high"] }),
        ...
        _push(`</div></div></div><div class="col-12 col-lg-6 mb-10" data-v-1b87d9d1>`);
        if (unref(Product)) {
          _push(ssrRenderComponent(_component_ProductDetailsProductImagesCarousel, {
            ProductImages: (_s = unref(Product)[0]) == null ? void 0 : _s.photos,
            ProductMainImg: (_t = unref(Product)[0]) == null ? void 0 : _t.photos[0]
          }, null, _parent));
        } else {
          _push(`<!---->`);
        }
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1b87d9d1"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-DUQOmngJ.mjs.map
