...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  }, _attrs))} data-v-d3aadd04><div class="${ssrRenderClass([("useSidebar" in _ctx ? _ctx.useSidebar : unref(useSidebar))().value ? "shrink" : "", "mainImg"])}" data-v-d3aadd04><img${ssrRenderAttr("src", _imports_0$1)} alt="" data-v-d3aadd04></div></div>`);
}
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-d3aadd04"]]);
const _sfc_main = {
  __name: "index",
...
//# sourceMappingURL=index-Cq3HGMRZ.mjs.map
