...
import { _ as __nuxt_component_5$1 } from './ProductCard-ChSx9Cyq.mjs';
            ...
            if (_push2) {
              ...
              ssrRenderList(unref(Reviews), (review) => {
                _push2(ssrRenderComponent(_component_SwiperSlide, null, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<div class="review" data-v-545af5b3${_scopeId2}><div class="leaf" data-v-545af5b3${_scopeId2}><img${ssrRenderAttr("src", _imports_1)} alt="" data-v-545af5b3${_scopeId2}></div><div class="title" data-v-545af5b3${_scopeId2}><img width="40"${ssrRenderAttr("src", _imports_2)} alt="" data-v-545af5b3${_scopeId2}><h2 class="mx-3" data-v-545af5b3${_scopeId2}>${ssrInterpolate(review.customer_name)}</h2></div><div class="desc" data-v-545af5b3${_scopeId2}>${ssrInterpolate(review.message)}</div><div class="rate" data-v-545af5b3${_scopeId2}>`);
...
//# sourceMappingURL=index-6MhcKE2Q.mjs.map
