...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(_attrs)} data-v-5e27e5d1><div class="table-content table-responsive" id="cart-container" data-v-5e27e5d1><table class="table" data-v-5e27e5d1><thead class="${ssrRenderClass([_ctx.$i18n.locale == "en" ? "headen" : "headar", "tabel-title"])}" data-v-5e27e5d1><tr data-v-5e27e5d1><th data-v-5e27e5d1>${ssrInterpolate(_ctx.$i18n.locale == "ar" ? "\u0627\u0644\u0635\u0648\u0631\u0629" : "Photo")}</th><th data-v-5e27e5d1>${ssrInterpolate(_ctx.$i18n.locale == "ar" ? "\u0627\u0644\u0627\u0633\u0645" : "Name")}</th><th data-v-5e27e5d1>${ssrInterpolate(_ctx.$i18n.locale == "ar" ? "\u0627\u0644\u0643\u0645\u064A\u0629" : "Quantity")}</th><th data-v-5e27e5d1>${ssrInterpolate(_ctx.$i18n.locale == "ar" ? "\u0627\u0644\u0633\u0639\u0631" : "Price")}</th></tr></thead><tbody data-v-5e27e5d1><!--[-->`);
      ssrRenderList(__props.cart.items, (item, index) => {
        var _a2;
        _push(`<!--[-->`);
        if (item) {
          _push(`<tr data-v-5e27e5d1><td data-v-5e27e5d1><img class="product-img"${ssrRenderAttr("src", `${unref(apiBase)}/${(_a2 = item.item) == null ? void 0 : _a2.photos[0].photoPath}`)} alt="" width="75" height="50" data-v-5e27e5d1></td><td data-v-5e27e5d1>`);
          if (item.item.id) {
            _push(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<h6${ssrRenderAttr("title", ("useTranslate" in _ctx ? _ctx.useTranslate : unref(useTranslate))(item.item, "name"))} data-v-5e27e5d1${_scopeId}>`);
                  if (item.item.selectedSize) {
                    _push2(`<span style="${ssrRenderStyle({ "font-size": "smaller", "color": "#00916d" })}" data-v-5e27e5d1${_scopeId}>(${ssrInterpolate(item.item.selectedSize)})</span>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  ...
                  return [
                    createVNode("h6", {
                      ...
                      item.item.selectedSize ? (openBlock(), createBlock("span", {
                        key: 0,
                        style: { "font-size": "smaller", "color": "#00916d" }
                      }, "(" + toDisplayString(item.item.selectedSize) + ")", 1)) : createCommentVNode("", true),
            ...
            _push(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<h6${ssrRenderAttr("title", ("useTranslate" in _ctx ? _ctx.useTranslate : unref(useTranslate))(item.item, "name"))} data-v-5e27e5d1${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale == "en" ? item.item.plant_name : item.item.plant_name)}</h6>`);
                } else {
                  return [
                    createVNode("h6", {
                      title: ("useTranslate" in _ctx ? _ctx.useTranslate : unref(useTranslate))(item.item, "name")
          ...
          _push(`</td><td data-v-5e27e5d1>`);
          _push(ssrRenderComponent(_component_font_awesome, {
            onClick: ($event) => increaseQty(item.id),
            icon: ["fas", "angle-up"],
            style: { "cursor": "pointer" }
          }, null, _parent));
          _push(`<span class="m-2 quantity text-black"${ssrRenderAttr("id", `quantity_${item.id}`)}${ssrRenderAttr("data-qty", item.qty)} data-v-5e27e5d1>${ssrInterpolate(item.qty)}</span>`);
          _push(ssrRenderComponent(_component_font_awesome, {
            style: { "cursor": "pointer" },
            onClick: ($event) => decreaseQty(item.id),
            icon: ["fas", "angle-down"]
          }, null, _parent));
          _push(`</td><td data-v-5e27e5d1>${ssrInterpolate((item.qty * item.price).toFixed(2))} ${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u062F\u064A\u0646\u0627\u0631" : "JOD")}</td></tr>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<!--]-->`);
      });
      _push(`<!--]--><tr data-v-5e27e5d1><td class="py-3 text-center" colspan="1" data-v-5e27e5d1><strong class="mb-0" data-v-5e27e5d1>${ssrInterpolate(_ctx.$i18n.locale == "ar" ? "\u0643\u0644\u0641\u0629 \u0627\u0644\u062A\u0648\u0635\u064A\u0644" : "Delviry Cost")}</strong></td><td colspan="1" data-v-5e27e5d1></td><td colspan="1" data-v-5e27e5d1></td><td class="py-3" data-v-5e27e5d1><strong class="mb-0" data-v-5e27e5d1>${ssrInterpolate(Number(("useDelviryCost" in _ctx ? _ctx.useDelviryCost : unref(useDelviryCost))().value))} ${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u062F\u064A\u0646\u0627\u0631" : "JOD")}</strong></td></tr><tr data-v-5e27e5d1><td class="py-3 text-center" colspan="1" data-v-5e27e5d1><strong class="mb-0" data-v-5e27e5d1>${ssrInterpolate(_ctx.$i18n.locale == "ar" ? "\u0627\u0644\u0633\u0639\u0631 \u0627\u0644\u0625\u062C\u0645\u0627\u0644\u064A" : "Total Price")}</strong></td><td colspan="1" data-v-5e27e5d1></td><td colspan="1" data-v-5e27e5d1></td><td class="py-3" data-v-5e27e5d1><strong class="mb-0" data-v-5e27e5d1>${ssrInterpolate(Number((_a = __props.cart.totalPrice) == null ? void 0 : _a.toFixed(2)) + Number(("useDelviryCost" in _ctx ? _ctx.useDelviryCost : unref(useDelviryCost))().value))} ${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u062F\u064A\u0646\u0627\u0631" : "JOD")}</strong></td></tr></tbody></table></div></section>`);
    };
  }
};
...
const __nuxt_component_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-5e27e5d1"]]);
const _sfc_main$4 = {
  __name: "VTextInput",
  __ssrInlineRender: true,
  props: {
...
//# sourceMappingURL=Order-Br26PyZI.mjs.map
