...
import { ssrRenderAttr, ssrRenderComponent, ssrInterpolate, ssrRenderClass, ssrRenderAttrs } from 'vue/server-renderer';
...
import { c as useUserInfo } from './useState-DDQ6Qtd2.mjs';
...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="leaf" data-v-cb5fa149><img${ssrRenderAttr("src", _imports_1)} alt="" data-v-cb5fa149></div><div class="leaf2" data-v-cb5fa149><img${ssrRenderAttr("src", _imports_1)} alt="" data-v-cb5fa149></div><div class="leaf3" data-v-cb5fa149><img${ssrRenderAttr("src", _imports_0)} alt="" data-v-cb5fa149></div><div class="leaf4" data-v-cb5fa149><img${ssrRenderAttr("src", _imports_0)} alt="" data-v-cb5fa149></div>`);
      ...
      if ((_b = (_a = __props.product) == null ? void 0 : _a.data) == null ? void 0 : _b.productOffer.discountRatio) {
        _push(`<div class="disscount" data-v-cb5fa149>${ssrInterpolate(((_d = (_c = __props.product) == null ? void 0 : _c.data) == null ? void 0 : _d.productOffer.discountRatio) + "%")}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(ssrRenderComponent(_component_nuxt_link, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a22, _b22, _c2, _d2, _e2, _f2, _g2, _h2, _i2, _j2, _k2, _l2, _m2, _n2, _o2, _p;
          if (_push2) {
            ...
            return [
              ((_j2 = (_i2 = __props.product) == null ? void 0 : _i2.photos) == null ? void 0 : _j2.photoPath) ? (openBlock(), createBlock(_component_ElementsImage, {
                ...
                key: 1,
                src: `${unref(apiBase)}/${(_p = (_o2 = __props.product) == null ? void 0 : _o2.photos[0]) == null ? void 0 : _p.photoPath}`,
                classes: "image-rendered"
      ...
      _push(`<div class="product-info" data-v-cb5fa149><div class="d-flex justify-content-between px-5 mt-4" data-v-cb5fa149><h5 class="title" data-v-cb5fa149>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? __props.product.plant_name : __props.product.plant_name)}</h5><div class="d-flex" data-v-cb5fa149><p class="price" data-v-cb5fa149><span class="${ssrRenderClass([((_i = (_h = __props.product) == null ? void 0 : _h.productOffer) == null ? void 0 : _i.newPrice) ? "old-price" : "", "mx-2"])}" data-v-cb5fa149>${ssrInterpolate((_j = __props.product) == null ? void 0 : _j.price)} ${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "JOD" : "JOD")}</span></p><p class="price" data-v-cb5fa149>${ssrInterpolate((_l = (_k = __props.product) == null ? void 0 : _k.productOffer) == null ? void 0 : _l.newPrice)}</p></div></div>`);
      _push(ssrRenderComponent(_component_nuxt_link, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span data-v-cb5fa149${_scopeId}>${ssrInterpolate(_ctx.$t("OrderNow"))}</span>`);
          } else {
            return [
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-cb5fa149"]]);

export { __nuxt_component_1 as _ };
//# sourceMappingURL=ProductCard2-BZr6qlhI.mjs.map
