...
import { B as BaseStyle, _ as _export_sfc, k as useI18n, o as useRoute$1, l as useFetch, u as useRuntimeConfig, F as FilterService } from './server.mjs';
import { _ as _imports_0 } from './virtual_public-C_LRNEiw.mjs';
import { _ as _imports_1 } from './virtual_public-DdiQcbvu.mjs';
import { f as useMainToken } from './useState-D7RI69Dw.mjs';
...
import { R as Ripple, s as script$e, d as script$5$1, c as script$4$1, b as script$2$1, a as script$3$1 } from './index-J5dMXp_o.mjs';
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-b62404ca"]]);
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Skeleton = script$c;
      _push(`<!--[-->`);
      if (!unref(loaded)) {
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-7d636516"]]);
const _sfc_main$1 = {
  __name: "ProductCard2",
  __ssrInlineRender: true,
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ElementsImage = __nuxt_component_1;
      _push(`<!--[--><div class="leaf" data-v-99c092a2><img${ssrRenderAttr("src", _imports_0)} alt="" data-v-99c092a2></div><div class="leaf2" data-v-99c092a2><img${ssrRenderAttr("src", _imports_0)} alt="" data-v-99c092a2></div><div class="leaf3" data-v-99c092a2><img${ssrRenderAttr("src", _imports_1)} alt="" data-v-99c092a2></div><div class="leaf4" data-v-99c092a2><img${ssrRenderAttr("src", _imports_1)} alt="" data-v-99c092a2></div>`);
      if ((_b = (_a = __props.product) == null ? void 0 : _a.data) == null ? void 0 : _b.productOffer.discountRatio) {
        _push(`<div class="disscount" data-v-99c092a2>${ssrInterpolate(((_d = (_c = __props.product) == null ? void 0 : _c.data) == null ? void 0 : _d.productOffer.discountRatio) + "%")}</div>`);
      } else {
        _push(`<!---->`);
      }
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_ElementsImage, {
              src: `${unref(apiBase)}/${(_a22 = __props.product) == null ? void 0 : _a22.photos}`,
              classes: "image-rendered"
            }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_component_ElementsImage, {
                src: `${unref(apiBase)}/${(_b22 = __props.product) == null ? void 0 : _b22.photos}`,
                classes: "image-rendered"
              }, null, 8, ["src"])
            ];
          }
      ...
      _push(`<div class="product-info" data-v-99c092a2><div class="d-flex justify-content-between px-5 mt-4" data-v-99c092a2><h5 class="title" data-v-99c092a2>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? __props.product.plant_name : __props.product.plant_name)}</h5><div class="d-flex" data-v-99c092a2><p class="price" data-v-99c092a2><span class="${ssrRenderClass([((_i = (_h = __props.product) == null ? void 0 : _h.productOffer) == null ? void 0 : _i.newPrice) ? "old-price" : "", "mx-2"])}" data-v-99c092a2>${ssrInterpolate((_j = __props.product) == null ? void 0 : _j.price)} ${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "AED" : "AED")}</span></p><p class="price" data-v-99c092a2>${ssrInterpolate((_l = (_k = __props.product) == null ? void 0 : _k.productOffer) == null ? void 0 : _l.newPrice)} ${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "AED" : "AED")}</p></div></div>`);
      _push(ssrRenderComponent(_component_nuxt_link, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span data-v-99c092a2${_scopeId}>${ssrInterpolate(_ctx.$t("OrderNow"))}</span>`);
          } else {
            return [
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-99c092a2"]]);
var script$b = {
  name: "BlankIcon",
  "extends": script$d
};
...
const _sfc_main = {
  ...
  async setup(__props) {
      ...
      if (!hasSubmenu) {
        ...
        if (!item2.parentCategoryId) {
          const { data: ProductsByCat, pending } = await useFetch(
            `${api.GetPlantsBySubCat}/${selectedId.value - 100}`,
            {
              baseURL: apiBase,
              headers: {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_font_awesome = _sfc_main$4;
      const _component_PanelMenu = script;
      const _component_ElementsSpinner = __nuxt_component_1$1;
      const _component_nuxt_link = __nuxt_component_2;
      const _component_Select = script$4;
      const _component_ProductCard2 = __nuxt_component_3;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "Products" }, _attrs))} data-v-f129ea28><div class="" data-v-f129ea28><div class="row" data-v-f129ea28><div class="${ssrRenderClass([_ctx.$i18n.locale === "ar" ? "ar" : "", "col-lg-2"])}" data-v-f129ea28><div class="wrapper" data-v-f129ea28><h2 data-v-f129ea28><span data-v-f129ea28>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? "\u0627\u0644\u0641\u0626\u0627\u062A" : "Categories")} `);
      _push(ssrRenderComponent(_component_font_awesome, {
        style: { "transform": "rotate(90deg)" },
        icon: ["fas", "sliders"]
      }, null, _parent));
      _push(`</span></h2><div class="allfilter mt-8" data-v-f129ea28>`);
      _push(ssrRenderComponent(_component_PanelMenu, {
        ...
        item: withCtx(({ item: item2, hasSubmenu }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="filterbox pointer d-flex justify-content-between" data-v-f129ea28${_scopeId}><span class="${ssrRenderClass([unref(selectedId) == item2.id ? "active" : "", "cat"])}" data-v-f129ea28${_scopeId}>${ssrInterpolate(_ctx.$i18n.locale == "en" ? item2.category_name : item2.category_name)}</span>`);
            if (hasSubmenu) {
              _push2(`<span class="drop-down" data-v-f129ea28${_scopeId}><span data-v-f129ea28${_scopeId}>&gt;</span></span>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
      ...
      if (unref(loading2) || _ctx.pending) {
        _push(`<div class="col-lg-10 loader" data-v-f129ea28>`);
        _push(ssrRenderComponent(_component_ElementsSpinner, null, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<div class="col-lg-10" data-v-f129ea28><div class="links" data-v-f129ea28>`);
        ...
        if ((_a = _ctx.Categories) == null ? void 0 : _a.parentCategoryId) {
          _push(`<span data-v-f129ea28> / ${ssrInterpolate(getMainCat(_ctx.Categories.parentCategoryId))}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(` / <span data-v-f129ea28>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? (_b = _ctx.Categories) == null ? void 0 : _b.category_name : (_c = _ctx.Categories) == null ? void 0 : _c.category_name)}</span></div><div class="title" data-v-f129ea28><h1 class="d-flex align-items-center" data-v-f129ea28><span class="underline" data-v-f129ea28>${ssrInterpolate(_ctx.$i18n.locale === "ar" ? (_d = _ctx.Categories) == null ? void 0 : _d.category_name : (_e = _ctx.Categories) == null ? void 0 : _e.category_name)}</span></h1></div><div class="d-flex justify-content-start align-items-end mb-10" data-v-f129ea28><div class="d-flex mt-5 justify-content-start align-items-center top" style="${ssrRenderStyle({ "flex-wrap": "wrap", "gap": "10px" })}" data-v-f129ea28><div class="select" data-v-f129ea28>`);
        ...
        _push(`</div></div></div><div class="grid3" data-v-f129ea28><!--[-->`);
        ssrRenderList(unref(filteredProducts), (product) => {
          _push(`<div class="product" data-aos="fade-up" data-v-f129ea28><div data-v-f129ea28>`);
        ...
        _push(`<!--]--></div><h1 style="${ssrRenderStyle([
          ...
          { "color": "#333" }
        ])}" class="text-center my-10 py-10" data-v-f129ea28>${ssrInterpolate(_ctx.$i18n.locale == "ar" ? "\u0646\u0639\u062A\u0630\u0631 \u0644\u0627 \u064A\u0648\u062C\u062F \u0645\u0646\u062A\u062C\u0627\u062A" : "Sorry No Items")}</h1></div>`);
      }
      _push(`</div></div></div>`);
    };
  }
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f129ea28"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-NaMEPVFO.mjs.map
